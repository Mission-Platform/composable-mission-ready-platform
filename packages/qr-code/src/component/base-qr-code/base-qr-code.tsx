...
export type { QrErrorCorrection } from '@mission-platform/qr-code';
 ...
 * `base-qr-code.module.scss`.
 */
export function BaseQrCode(properties: Readonly<QrCodeProperties>): MpElement {
  const {
    value,
    variant = 'qr',
    errorCorrection = 'M',
