/**
 * Framework-neutral **named slots** for the `@mission-platform/forge-jsx` dialect.
 *
 ...
 * runtime adapters (`@mission-platform/forge-adapters/react`, `.../vue`) and SSR: each
 ...
 * `@mission-platform/forge-jsx`; both the runtime adapters and the build-time compiler
