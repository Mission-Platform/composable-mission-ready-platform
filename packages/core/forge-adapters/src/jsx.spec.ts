import { jsx, jsxs } from '@mission-platform/forge-jsx/jsx-runtime';
import { Fragment, h, HtmlContent, isMpElement, type MpComponent, Slot } from '@mission-platform/forge-jsx/runtime';
...
describe('@mission-platform/forge-jsx runtime', () => {
...
describe('@mission-platform/forge-jsx adapters render the same tree on React and Vue', () => {
...
describe('@mission-platform/forge-jsx adapters render nothing for an empty (null) render on both frameworks', () => {
