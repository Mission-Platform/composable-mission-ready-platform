...
export const documentationCompatibilityFixture: ForgeCompatibilityFixture = {
  ...
  cases: [
    ...
    { id: 'docs-nested-document', path: '/packages/tooling/configs/index', expectedRoute: 'doc' },
    { id: 'docs-localized-document', path: '/fr/packages/tooling/configs/index', expectedRoute: 'localized-doc' },
