 ...
 * and shipped to both React (this story, via `@mission-platform/breakpoints/react`)
 * and Vue 3 (`@mission-platform/breakpoints/vue`). A development-time overlay
 * pinned to the bottom-right corner showing the current breakpoint and which
