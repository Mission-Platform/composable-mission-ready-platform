...
/**
 * Exercises the **neutral** `BreakpointDebug` through the `@mission-platform/forge`
...
const ReactBreakpointDebug = toReactComponent(BreakpointDebug, 'BreakpointDebug');
const VueBreakpointDebug = toVueComponent(BreakpointDebug, 'BreakpointDebug');

describe('BreakpointDebug authors the same component for React and Vue', () => {
