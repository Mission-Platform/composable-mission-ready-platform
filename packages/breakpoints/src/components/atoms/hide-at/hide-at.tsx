...
export interface HideAtProperties extends MpProperties {
...
/**
 * `HideAt` — the inverse of {@link ShowAt}: it hides its default slot when the
 ...
 */
export function HideAt(properties: Readonly<HideAtProperties>): MpElement {
