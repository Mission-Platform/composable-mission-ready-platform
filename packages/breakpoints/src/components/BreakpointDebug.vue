...
<template>
  <div class="bp-debug" aria-hidden="true">
    <span class="bp-debug__label">breakpoint:</span>
    <span class="bp-debug__current">{{ current }}</span>
    <span class="bp-debug__separator">|</span>
    <span
    ...
    >
      {{ key }}
      <span class="bp-debug__px">({{ breakpoints[key] === 0 ? '0' : `${breakpoints[key]}` }}px)</span>
    </span>
  </div>
</template>
