...
//
// This module lives in `@mission-platform/forms-core` so the Vue
// `@mission-platform/components` SchemaForm and the write-once
// `@mission-platform/components` SchemaForm share one definition (parity by
// construction).
