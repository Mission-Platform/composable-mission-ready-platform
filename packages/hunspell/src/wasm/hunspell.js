async function createHunspell(moduleArg = {}) {
  var moduleRtn;
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('hunspell.wasm');
    }
  ...
  var InvokerFunctions = {
    ...
    ftf: function anonymous(humanName, throwBindingError, invoker, fn, runDestructors, fromRetWire, toClassParamWire) {
      return function () {
        var rv = invoker(fn);
        var ret = fromRetWire(rv);
        return ret;
    ...
    ttfn: function anonymous(humanName, throwBindingError, invoker, fn, runDestructors, fromRetWire, toClassParamWire) {
      return function () {
        var thisWired = toClassParamWire(null, this);
