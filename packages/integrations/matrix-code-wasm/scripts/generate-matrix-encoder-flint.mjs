 ...
 *
 * Flint constraints handled here:
...
const outPath = join(root, 'src/fws/matrix-encoder.flint');
...
/**
 * Emits Flint function definitions for precomputed Data Matrix placement maps across all supported dimensions.
 */
...
/**
 * Flint v1 deliberately does not support arithmetic grouping parentheses. Keep
