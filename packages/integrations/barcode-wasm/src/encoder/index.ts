// Public, typed wrapper around the package-local Flint barcode graphs.

import { load as loadBarcodeNative, loadSync as loadBarcodeNativeSync } from '../fws/barcode-native.flint';
...
/** Convert a direct Flint module-bit string into the public barcode contract. */
...
/**
 * Encode `data` into a linear barcode using the package-local Flint graph.
 *
...
/** Encode `data` asynchronously using the package-local Flint graph. */
