 ...
 */
export function createFlintModuleSource(compiled: FlintCompiledModule): string {
...
export function createFlintManifestSource(
 ...
 */
export function createFlintDeclarationsSource(
  compiled: FlintCompiledModule,
): string {
  const graphMetadata = {
...
export function createFlintWasmSource(compiled: FlintCompiledModule): string {
...
export function createFlintArtifactSource(
  compiled: FlintCompiledModule,
): string {
  if (compiled.artifact.wasm === undefined)
    throw new Error(
 ...
 */
export function createFlintWatSource(compiled: FlintCompiledModule): string {
...
export function createFlintSourceMapSource(
  compiled: FlintCompiledModule,
): string {
