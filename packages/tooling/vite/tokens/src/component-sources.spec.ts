...
const componentDirectory = path.join(repositoryRoot, 'packages/ui/tokens/tokens/component');
const monolithPath = path.join(repositoryRoot, 'packages/ui/tokens/tokens/component.tokens.json');
const referencePath = path.join(repositoryRoot, 'packages/ui/tokens/docs/reference/component-tokens.md');
