...
`packages/ui/tokens/tokens/component/{atoms,molecules,organisms,templates}/` source
...
```jsonc
{
  ...
  "$schema": "../../../packages/tooling/vite/token-overrides/schema/token-overrides.schema.json",
  "component": {
    "button": {
      "primary": {
        "background": {
