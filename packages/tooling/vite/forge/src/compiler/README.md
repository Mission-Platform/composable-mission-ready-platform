...
The committed `packages/tooling/vite/forge/benchmarks/typescript-baseline.json` is the
...
`packages/tooling/vite/forge/benchmarks/oxc-comparison.json`. Its JSON report contains
