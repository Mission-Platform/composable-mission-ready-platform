...
import { BaseWysiwygEditor } from './base-wysiwyg-editor';

/**
 * Exercises the **neutral** `BaseWysiwygEditor` authored in this package,
 ...
 */
const ReactWysiwygEditor = toReactComponent(BaseWysiwygEditor, 'WysiwygEditor');
const VueWysiwygEditor = toVueComponent(BaseWysiwygEditor, 'WysiwygEditor');
...
describe('BaseWysiwygEditor authors the same component for React and Vue', () => {
  ...
  // the code-block dialog embeds a heavy `BaseMonacoEditor`. It must be mounted
