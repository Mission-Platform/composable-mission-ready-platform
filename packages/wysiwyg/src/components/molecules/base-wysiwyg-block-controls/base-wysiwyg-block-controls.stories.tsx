...
import { WysiwygBlockControls } from '@mission-platform/wysiwyg';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `WysiwygBlockControls` is the write-once `BaseWysiwygBlockControls` — the
 ...
 */
const meta = {
  title: 'Molecules/Editor/WysiwygBlockControls',
  ...
  render: (arguments_) => (
    <div style={{ position: 'relative', height: 200, border: '1px dashed var(--mp-color-border-subtle)' }}>
      <WysiwygBlockControls {...arguments_} />
    </div>
  ),
