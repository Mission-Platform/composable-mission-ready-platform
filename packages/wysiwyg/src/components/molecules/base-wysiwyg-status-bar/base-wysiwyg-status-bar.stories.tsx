import { WysiwygStatusBar } from '@mission-platform/wysiwyg';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `WysiwygStatusBar` is the write-once `BaseWysiwygStatusBar` — the editor's
 ...
 */
const meta = {
  title: 'Molecules/Editor/WysiwygStatusBar',
