...
import { BaseWysiwygStatusBar } from './base-wysiwyg-status-bar';

const ReactStatusBar = toReactComponent(BaseWysiwygStatusBar, 'WysiwygStatusBar');
const VueStatusBar = toVueComponent(BaseWysiwygStatusBar, 'WysiwygStatusBar');
...
describe('BaseWysiwygStatusBar authors the same component for React and Vue', () => {
