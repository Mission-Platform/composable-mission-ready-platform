...
import { Masonry } from '@mission-platform/components';
...
/**
 * `Masonry` is the write-once `BaseMasonry` component of `@mission-platform/components` — it flows its default-slot children into
 * balanced, tightly-packed CSS multi-columns.
 * This single neutral story renders on the framework selected by `STORYBOOK_FRAMEWORK`.
 */
const meta = {
  title: 'Molecules/Layout/BaseMasonry',
  component: Masonry,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `Masonry` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It flows its default-slot children into balanced, tightly-packed CSS multi-columns. The demo card styling comes from the co-located `base-masonry.module.scss` CSS Module.',
      },
    },
  },
  argTypes: {
