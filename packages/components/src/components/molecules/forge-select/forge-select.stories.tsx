...
import { ForgeSelect } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeSelect` is the write-once `ForgeSelect` component of `@mission-platform/components`. By default it is **searchable**: the trigger is
