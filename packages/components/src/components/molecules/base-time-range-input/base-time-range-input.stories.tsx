...
import { TimeRangeInput } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `TimeRangeInput` is the write-once `BaseTimeRangeInput` component of `@mission-platform/components`
 ...
 */
const meta = {
  title: 'Molecules/Forms/BaseTimeRangeInput',
