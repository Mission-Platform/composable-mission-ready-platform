...
import { Breadcrumb } from '@mission-platform/components';
...
/**
 * `Breadcrumb` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Navigation/BaseBreadcrumb',
