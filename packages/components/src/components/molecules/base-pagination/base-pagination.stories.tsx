...
import { Pagination } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `Pagination` is the write-once `BasePagination` component of `@mission-platform/components`. It renders page buttons with optional
 ...
 */
const meta = {
  title: 'Molecules/Navigation/BasePagination',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `Pagination` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It renders page buttons with optional first/previous/next/last controls and MUI-style truncation ellipses; the page is controlled via `modelValue`. Styling comes from the co-located `base-pagination.module.scss`.',
      },
    },
  },
  argTypes: {
