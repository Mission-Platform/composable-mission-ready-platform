...
import { Select } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `Select` is the write-once `BaseSelect` component of `@mission-platform/components`. By default it is **searchable**: the trigger is
 ...
 */
const meta = {
  title: 'Molecules/Forms/BaseSelect',
  component: Select,
  tags: ['autodocs'],
  parameters: {
    docs: {
