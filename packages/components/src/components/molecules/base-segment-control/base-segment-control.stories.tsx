...
import { SegmentControl } from '@mission-platform/components';
...
/**
 * `SegmentControl` is the write-once `BaseSegmentControl` component of `@mission-platform/components`
 ...
 */
const meta = {
  title: 'Molecules/Navigation/BaseSegmentControl',
