...
import { ForgeMultiselect } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeMultiselect` is the write-once `ForgeMultiselect` component of `@mission-platform/components`. Selected values render as removable `Tag` chips
