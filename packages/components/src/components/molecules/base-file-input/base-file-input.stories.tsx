...
import { FileInput } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `FileInput` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Forms/BaseFileInput',
  component: FileInput,
  tags: ['autodocs'],
  parameters: {
    docs: {
