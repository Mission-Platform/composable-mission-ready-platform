import { h, type MpChild, type MpElement, type MpProperties, useId } from '@mission-platform/forge';

import sizeStyles from '../../../styles/size.module.scss';
import { BaseRadio } from '../../atoms/base-radio';
import { BaseStack } from '../../atoms/base-stack';
