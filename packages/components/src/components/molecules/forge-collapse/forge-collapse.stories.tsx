...
/**
 * `ForgeCollapse` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Display/ForgeCollapse',
  component: ForgeCollapse,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ForgeCollapse` — authored once in the neutral JSX dialect and shipped to all supported frameworks. Built on the native `<details>` element: the clickable summary uses the `summary` slot (or `summary` prop) and the body is the default slot, with a CSS-rotated chevron. Styling comes from the co-located `forge-collapse.module.scss`.',
      },
    },
  },
  argTypes: {
