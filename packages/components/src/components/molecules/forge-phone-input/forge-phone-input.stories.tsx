...
import { ForgePhoneInput } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgePhoneInput` is the write-once `ForgePhoneInput` component of `@mission-platform/components`. A country picker sits beside a `type="tel"`
 ...
 */
const meta = {
  title: 'Molecules/Forms/ForgePhoneInput',
  component: ForgePhoneInput,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ForgePhoneInput` — authored once in the neutral JSX dialect and shipped to all supported frameworks. A country picker sits beside a `type="tel"` field; the input is formatted as-you-type and validated with `@mission-platform/phone-number`. Styling comes from the co-located `forge-phone-input.module.scss`.',
      },
    },
  },
  argTypes: {
...
} satisfies Meta<typeof ForgePhoneInput>;
