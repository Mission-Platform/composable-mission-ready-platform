...
import { ForgeToast } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeToast` is the write-once `ForgeToast` component of `@mission-platform/components` — the presentational toast item: an intent
