...
import { DeviceMock } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `DeviceMock` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Display/BaseDeviceMock',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `DeviceMock` — authored once in the neutral JSX dialect and shipped to all supported frameworks. Pick a `device` frame (`mobile`, `tablet`, `desktop`, `browser`); the default slot is projected onto the device screen. Styling comes from the co-located `base-device-mock.module.scss`.',
      },
    },
  },
  argTypes: {
