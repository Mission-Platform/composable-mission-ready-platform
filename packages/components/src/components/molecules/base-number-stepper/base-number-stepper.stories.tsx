...
import { NumberStepper } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `NumberStepper` is the write-once `BaseNumberStepper` component of `@mission-platform/components`
 ...
 */
const meta = {
  title: 'Molecules/Forms/BaseNumberStepper',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `NumberStepper` — authored once in the neutral JSX dialect and shipped to all supported frameworks. A number field flanked by −/+ buttons; the value is controlled via `modelValue` (a `number` or `null`). Styling comes from the co-located `base-number-stepper.module.scss`.',
      },
    },
  },
  argTypes: {
