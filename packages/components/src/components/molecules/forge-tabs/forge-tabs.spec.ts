...
/**
 * Exercises the **neutral** `ForgeTabs` authored in this package, rendering it on
 ...
 */
const ReactTabs = toReactComponent(ForgeTabs, 'Tabs');
const VueTabs = toVueComponent(ForgeTabs, 'Tabs');
...
describe('ForgeTabs authors the same component for React and Vue', () => {
