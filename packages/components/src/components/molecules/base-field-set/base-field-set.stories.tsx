...
import { FieldSet, Input, PhoneInput, Textarea } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `FieldSet` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Forms/BaseFieldSet',
  component: FieldSet,
  tags: ['autodocs'],
  parameters: {
    docs: {
