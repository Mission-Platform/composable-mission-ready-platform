...
import { ForgeSearchInput } from './forge-search-input';

/**
 * Exercises the **neutral** `ForgeSearchInput` authored in this package,
 ...
 */
const ReactSearchInput = toReactComponent(ForgeSearchInput, 'SearchInput');
const VueSearchInput = toVueComponent(ForgeSearchInput, 'SearchInput');

describe('ForgeSearchInput authors the same component for React and Vue', () => {
