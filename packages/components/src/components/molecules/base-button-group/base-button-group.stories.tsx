...
import { Button, ButtonGroup } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ButtonGroup` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Display/BaseButtonGroup',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ButtonGroup` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It wraps grouped buttons in a flex container; set `attached` to visually join them into a single segmented control. Styling comes from the co-located `base-button-group.module.scss`.',
      },
    },
  },
  argTypes: {
