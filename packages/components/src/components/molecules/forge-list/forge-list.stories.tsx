import { ForgeList } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeList` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Molecules/Display/ForgeList',
  component: ForgeList,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ForgeList` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It renders the `items` array as an ordered/unordered/description/plain list (each row via the composed neutral `Typography`). Styling comes from the co-located `forge-list.module.scss`.',
      },
    },
  },
  argTypes: {
  ...
  render: (arguments_) => <ForgeList {...arguments_} />,
} satisfies Meta<typeof ForgeList>;
