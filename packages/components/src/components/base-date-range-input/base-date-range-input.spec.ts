...
import { BaseDateRangeInput } from './base-date-range-input';

/**
 * Exercises the **neutral** `BaseDateRangeInput` authored in this package,
 * rendering it on both frameworks through the `@mission-platform/jsx` adapters.
 ...
 */
const ReactDateRangeInput = toReactComponent(BaseDateRangeInput, 'DateRangeInput');
const VueDateRangeInput = toVueComponent(BaseDateRangeInput, 'DateRangeInput');

describe('BaseDateRangeInput authors the same component for React and Vue', () => {
