...
import { BaseVirtualTabs } from './base-virtual-tabs';
 ...
 */
const ReactVirtualTabs = toReactComponent(BaseVirtualTabs, 'VirtualTabs');
const VueVirtualTabs = toVueComponent(BaseVirtualTabs, 'VirtualTabs');
...
describe('BaseVirtualTabs authors the same component for React and Vue', () => {
