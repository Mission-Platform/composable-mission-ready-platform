...
import { IconCalendar, IconGlobe } from '@mission-platform/icons';
...
import { BaseCalendar } from '../../molecules/base-calendar';
import { BaseDropdown } from '../../molecules/base-dropdown';
...
/**
 * `BaseDateTimeRangeInput` — a date-time-range picker authored once in the
 * neutral JSX dialect and compiled straight to React or Vue by
 * `@mission-platform/vite-plugin-forge`.
 *
 * A trigger button shows the `start → end (timezone)` summary and opens a
 * popover with a browser/UTC toggle above a two-step {@link BaseFormWizard}
 * (**Date**, then **Time**): the **Date** step picks the range's start/end dates
 * on two {@link BaseCalendar}s, and the **Time** step picks the start/end times
 ...
 * `base-date-time-range-input.module.scss`.
 *
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <IconGlobe size="xs" /> {browserTimezoneLabel()}
            </button>
            <button
