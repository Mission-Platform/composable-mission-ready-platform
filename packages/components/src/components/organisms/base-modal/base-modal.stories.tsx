...
import { Button, Dropdown, Modal, Select, Stack, Tooltip, Typography } from '@mission-platform/components';
 ...
 */
const meta = {
  title: 'Organisms/Overlays/BaseModal',
  component: Modal,
  tags: ['autodocs'],
  parameters: {
    docs: {
