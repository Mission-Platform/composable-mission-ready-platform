...
import { ThemeProvider, ThemeToggle } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ThemeProvider` is the write-once `BaseThemeProvider` component of `@mission-platform/components`. It configures the shared observable theme store
 ...
 */
const meta = {
  title: 'Organisms/Theme/BaseThemeProvider',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ThemeProvider` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It configures the shared theme store and exposes `{ theme, resolvedTheme, systemTheme, setTheme, toggleTheme, cycleTheme }` to its default scoped slot.',
      },
    },
  },
  argTypes: {
