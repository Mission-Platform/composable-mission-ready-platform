...
import { Checkbox, FormWizard, Input } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `FormWizard` is the write-once component of `@mission-platform/components`.
...
const meta = {
  title: 'Organisms/Forms/BaseFormWizard',
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Cross-framework `FormWizard` — authored once in the neutral JSX dialect and shipped to all supported frameworks. Each step's body is its `content` prop; a step can be conditional (`when: false` drops it) and validated (`valid: false` blocks Next and the final Finish). Styling comes from the co-located `base-form-wizard.module.scss`.",
      },
    },
  },
  argTypes: {
