...
import { VirtualTable } from '@mission-platform/components';
...
/**
 * `VirtualTable` is the write-once `BaseVirtualTable` component of `@mission-platform/components`. Only the rows within the viewport are rendered;
 ...
 */
const meta = {
  title: 'Organisms/Data/BaseVirtualTable',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `VirtualTable` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It virtual-scrolls a large `rows` array beneath a sticky, click-to-sort header, firing `onSort`/`onRowClick`, with a `footer` named slot.',
      },
    },
  },
  argTypes: {
