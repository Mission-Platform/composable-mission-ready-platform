...
import { Carousel } from '@mission-platform/components';
...
/**
 * `Carousel` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Organisms/Display/BaseCarousel',
  component: Carousel,
  tags: ['autodocs'],
  parameters: {
    docs: {
