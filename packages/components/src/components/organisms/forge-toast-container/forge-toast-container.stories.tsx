...
import { ForgeButton, ForgeToastContainer, useToast } from '@mission-platform/components';

import type { ToastPosition } from '@mission-platform/components';
import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeToastContainer` is the write-once `ForgeToastContainer` component of `@mission-platform/components`
