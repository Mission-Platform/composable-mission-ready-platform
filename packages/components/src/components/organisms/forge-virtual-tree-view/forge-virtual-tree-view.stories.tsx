 ...
 */
const meta = {
  title: 'Organisms/Data/ForgeVirtualTreeView',
  component: ForgeVirtualTreeView,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ForgeVirtualTreeView` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It flattens the expanded tree and virtual-scrolls the visible rows, with a built-in expand/collapse label and `onSelect`/`onToggle` callbacks.',
      },
    },
  },
  argTypes: {
  ...
  render: (arguments_) => <ForgeVirtualTreeView {...arguments_} />,
} satisfies Meta<typeof ForgeVirtualTreeView>;
