...
import { ForgeThemeProvider, ForgeThemeToggle } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeThemeProvider` is the write-once `ForgeThemeProvider` component of `@mission-platform/components`. It configures the shared observable theme store
