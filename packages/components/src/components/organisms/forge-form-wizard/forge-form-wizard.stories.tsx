...
import { ForgeCheckbox, ForgeFormWizard, ForgeInput } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeFormWizard` is the write-once component of `@mission-platform/components`.
