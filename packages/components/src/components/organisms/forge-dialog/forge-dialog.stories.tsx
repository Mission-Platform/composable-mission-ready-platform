...
import { ForgeButton, ForgeDialog, ForgeStack, ForgeTypography } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeDialog` is the write-once component of `@mission-platform/components`.
