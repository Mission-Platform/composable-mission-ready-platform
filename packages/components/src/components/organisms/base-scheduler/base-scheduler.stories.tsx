...
import { Scheduler } from '@mission-platform/components';

import type { VEvent } from './base-scheduler';
import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `Scheduler` is the write-once `BaseScheduler` component of `@mission-platform/components`. A toolbar sits above a time grid (day / 3-day /
 ...
 */
const meta = {
  title: 'Organisms/Forms/BaseScheduler',
  component: Scheduler,
  tags: ['autodocs'],
  parameters: {
    docs: {
