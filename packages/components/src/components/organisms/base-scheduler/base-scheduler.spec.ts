...
import { BaseScheduler, type VEvent } from './base-scheduler';
 ...
 */
const ReactScheduler = toReactComponent(BaseScheduler, 'Scheduler');
const VueScheduler = toVueComponent(BaseScheduler, 'Scheduler');
...
describe('BaseScheduler authors the same component for React and Vue', () => {
