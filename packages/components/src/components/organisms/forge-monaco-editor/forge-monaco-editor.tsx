import { h, type MpElement, type MpProperties, useEffect, useRef } from '@mission-platform/forge';
 ...
 */
export function ForgeMonacoEditor(properties: Readonly<MonacoEditorProperties>): MpElement {
  const {
    modelValue = '',
    language = 'plaintext',
    theme = 'vs',
