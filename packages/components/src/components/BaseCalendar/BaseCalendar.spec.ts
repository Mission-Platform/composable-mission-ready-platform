...
describe('BaseCalendar', () => {
  ...
  it('emits update:modelValue when a day is clicked', async () => {
    const wrapper = mountWithI18n(BaseCalendar, { props: { modelValue: '2025-06-01' } })
    const day15 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-15')
  ...
  it('emits change when a day is clicked', async () => {
    ...
    const day10 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-10')
  ...
  it('disables dates before min', () => {
    ...
    const day9 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-09')
  ...
  it('disables dates after max', () => {
    ...
    const day21 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-21')
  ...
  it('disables explicitly listed dates', () => {
    ...
    const day5 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-05')
    const day12 = wrapper
      .findAll('.base-calendar__day')
      .find((b) => b.attributes('aria-label') === '2025-06-12')
