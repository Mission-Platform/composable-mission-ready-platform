...
import styles from './base-progress-bar.module.scss';
...
export function BaseProgressBar(properties: Readonly<ProgressBarProperties>): MpElement {
  ...
  const trackClassName = classNames(
    styles['base-progress-bar__track'],
    styles[`base-progress-bar__track--${variant}`],
    {
      [styles['base-progress-bar__track--indeterminate']]: indeterminate,
    },
  );
