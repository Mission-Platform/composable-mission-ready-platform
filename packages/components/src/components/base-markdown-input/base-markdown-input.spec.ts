...
import { BaseMarkdownInput } from './base-markdown-input';

/**
 * Exercises the **neutral** `BaseMarkdownInput` authored in this package,
 ...
 */
const ReactMarkdownInput = toReactComponent(BaseMarkdownInput, 'MarkdownInput');
const VueMarkdownInput = toVueComponent(BaseMarkdownInput, 'MarkdownInput');

describe('BaseMarkdownInput authors the same component for React and Vue', () => {
