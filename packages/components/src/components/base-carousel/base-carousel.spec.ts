...
/**
 * Exercises the **neutral** `BaseCarousel` authored in this package, rendering
 ...
 */
const ReactCarousel = toReactComponent(BaseCarousel, 'Carousel');
const VueCarousel = toVueComponent(BaseCarousel, 'Carousel');
...
describe('BaseCarousel authors the same component for React and Vue', () => {
