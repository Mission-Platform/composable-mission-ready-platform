import { Navbar } from '@mission-platform/components/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `Navbar` is the **React** build of the write-once `BaseNavbar` in
 * `@mission-platform/components`. It composes the write-once `Drawer` (mobile
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Cross-framework `Navbar` — authored once in the neutral JSX dialect and shipped to both React (this story, via `@mission-platform/components/react`) and Vue 3 (`@mission-platform/components/vue`). It composes the write-once `Drawer` and `Typography`, with a `brand` slot, the centred default slot, and an `end` slot that collapse to a hamburger-toggled drawer below the `sm` breakpoint. Styling comes from the co-located `base-navbar.module.scss`.',
      },
    },
  },
  argTypes: {
