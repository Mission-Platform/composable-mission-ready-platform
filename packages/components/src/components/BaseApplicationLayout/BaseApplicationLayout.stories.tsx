...
import BaseApplicationLayout from './BaseApplicationLayout.vue'
...
const sampleRender =
  (statusMessage?: string, statusIcon?: string) => (args: Record<string, unknown>) => ({
    components: {
    ...
    setup() {
      return { args, statusMessage, statusIcon }
    },
    template: `
...
export const StatusWarning: Story = {
  ...
  render: sampleRender(
    'Degraded connectivity detected in sector 4. Monitoring in progress.',
    'warning',
  ),
}
