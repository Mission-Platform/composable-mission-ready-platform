...
import { Switch } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `Switch` is the write-once `BaseSwitch` component of `@mission-platform/components`. A `role="switch"` checkbox styled as a sliding
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `Switch` — authored once in the neutral JSX dialect and shipped to all supported frameworks. A `role="switch"` checkbox styled as a sliding track/thumb; the value is controlled via `modelValue`. Styling comes from the co-located `base-switch.module.scss`.',
      },
    },
  },
  argTypes: {
