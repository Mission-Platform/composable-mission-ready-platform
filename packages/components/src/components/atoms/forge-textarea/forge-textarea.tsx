import { h, hasSlot, type MpChild, type MpElement, type MpProperties, Slot, useId } from '@mission-platform/forge';
...
export function ForgeTextarea(properties: Readonly<TextareaProperties>): MpElement {
  ...
  return (
    <div
      className={[
        styles['forge-textarea'],
        styles[`forge-textarea--${size}`],
        {
          [styles['forge-textarea--error']]: !!error,
          [styles['forge-textarea--disabled']]: disabled,
        },
      ]}
    >
      {label ? (
        <label
          className={[
            styles['forge-textarea__label'],
            {
              [styles['forge-textarea__label--hidden']]: labelHidden,
            },
          ]}
          for={resolvedId}
        >
          ...
          {required ? (
            <span
              aria-hidden="true"
              className={styles['forge-textarea__required']}
              title="required"
            >
              *
            </span>
      ...
      <div className={styles['forge-textarea__wrapper']}>
        {hasSlot('start') ? (
          <span className={[styles['forge-textarea__extension'], styles['forge-textarea__extension--start']]}>
            <Slot name="start" />
          </span>
        ) : undefined}
        <textarea
          ...
          className={styles['forge-textarea__field']}
          disabled={disabled}
        ...
        />
        {hasSlot('end') ? (
          <span className={[styles['forge-textarea__extension'], styles['forge-textarea__extension--end']]}>
            <Slot name="end" />
          </span>
        ) : undefined}
      </div>
      {error ? (
        <p
          id={`${resolvedId}-error`}
          className={styles['forge-textarea__error']}
          role="alert"
        >
          <ForgeTypography
            as="span"
        ...
        <p
          id={`${resolvedId}-hint`}
          className={styles['forge-textarea__hint']}
        >
          <ForgeTypography
            as="span"
            color="secondary"
