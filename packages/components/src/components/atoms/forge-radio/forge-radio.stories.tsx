...
import { ForgeRadio } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeRadio` is the write-once `ForgeRadio` component of `@mission-platform/components`. A radio is selected when its `value` equals the
