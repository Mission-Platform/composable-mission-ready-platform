...
import { ResponsiveVideo } from '@mission-platform/components';
...
/**
 * `ResponsiveVideo` is the write-once `BaseResponsiveVideo` component of
...
const meta = {
  title: 'Atoms/Media/BaseResponsiveVideo',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ResponsiveVideo` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It renders a `<video>` that scales to its container with a fixed aspect ratio, format-specific sources, a poster, and playback controls. Styling comes from the co-located `base-responsive-video.module.scss`.',
      },
    },
  },
  argTypes: {
