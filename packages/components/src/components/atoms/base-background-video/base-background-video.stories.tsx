...
import { BackgroundVideo } from '@mission-platform/components';
...
/**
 * `BackgroundVideo` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Atoms/Media/BaseBackgroundVideo',
