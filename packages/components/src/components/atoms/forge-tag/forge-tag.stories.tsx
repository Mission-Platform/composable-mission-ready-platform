...
import { ForgeTag } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeTag` is the write-once `ForgeTag` component of `@mission-platform/components` — a toned, rounded label (text via the composed
