...
import styles from './forge-range-input.module.scss';
...
export function ForgeRangeInput(properties: Readonly<RangeInputProperties>): MpElement {
  ...
  return (
    <div
      className={[
        styles['forge-range-input'],
        styles[`forge-range-input--${size}`],
        {
    ...
    >
      <div
        ref={trackReference}
        className={styles['forge-range-input__track']}
        onPointerdown={handleTrackPointerDown}
      >
        <div
          className={styles['forge-range-input__fill']}
        ...
        <div
          ...
          className={[styles['forge-range-input__thumb'], styles['forge-range-input__thumb--min']]}
          role="slider"
        ...
        >
          {showValue ? <span className={styles['forge-range-input__value']}>{displayLower}</span> : undefined}
        </div>
        <div
          aria-disabled={disabled || undefined}
          ...
          className={[styles['forge-range-input__thumb'], styles['forge-range-input__thumb--max']]}
          role="slider"
        ...
        >
          {showValue ? <span className={styles['forge-range-input__value']}>{displayUpper}</span> : undefined}
        </div>
      </div>
    </div>
  );
