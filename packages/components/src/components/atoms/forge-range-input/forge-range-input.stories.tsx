...
import { ForgeRangeInput } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeRangeInput` is the write-once `ForgeRangeInput` component of `@mission-platform/components`. It renders two bespoke `role="slider"` thumbs
