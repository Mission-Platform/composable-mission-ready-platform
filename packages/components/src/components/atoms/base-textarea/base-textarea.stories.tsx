...
import { Textarea } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `Textarea` is the write-once `BaseTextarea` component of `@mission-platform/components`. The value is controlled via `modelValue`; the
 ...
 */
const meta = {
  title: 'Atoms/Forms/BaseTextarea',
  component: Textarea,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `Textarea` — authored once in the neutral JSX dialect and shipped to all supported frameworks. The value is controlled via `modelValue`; the `start`/`end` named slots become `MpChild` content props. Styling comes from the co-located `base-textarea.module.scss`.',
      },
    },
  },
  argTypes: {
