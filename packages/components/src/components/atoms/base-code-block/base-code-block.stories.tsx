import { CodeBlock } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `CodeBlock` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Atoms/Display/BaseCodeBlock',
  component: CodeBlock,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `CodeBlock` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It highlights `code` with `highlight.js` (kept verbatim) and injects the markup into a `<code>` host via a `useRef` + `useEffect` `innerHTML` assignment (replacing `v-html`); the hljs token theme ships as a global side-effect stylesheet. Chrome styling comes from the co-located `base-code-block.module.scss`.',
      },
    },
  },
  argTypes: {
