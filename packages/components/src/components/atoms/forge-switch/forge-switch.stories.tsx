...
import { ForgeSwitch } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeSwitch` is the write-once `ForgeSwitch` component of `@mission-platform/components`. A `role="switch"` checkbox styled as a sliding
