...
import { IconButton } from '@mission-platform/components';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconButton` is the write-once component of `@mission-platform/components`.
 ...
 */
const meta = {
  title: 'Atoms/Display/BaseIconButton',
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `IconButton` — authored once in the neutral JSX dialect and shipped to all supported frameworks. Place the icon in the default slot; an accessible name is required via `label`. Styling comes from the co-located `base-icon-button.module.scss`. The demo uses a simple inline glyph in place of an `@mission-platform/icons` icon.',
      },
    },
  },
  argTypes: {
