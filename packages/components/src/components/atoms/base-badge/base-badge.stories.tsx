...
import { BaseBadge } from '@mission-platform/components';

import type { BadgeProperties } from './base-badge';
import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `BaseBadge` is the write-once badge component of `@mission-platform/components`.
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `BaseBadge` — authored once in the neutral JSX dialect and shipped to all supported frameworks. The component owns its `@layer mp.components` styling via the co-located `base-badge.module.scss` (shipped in the built package CSS) and assembles its BEM class names with the neutral `classNames` helper.',
      },
    },
  },
  argTypes: {
  ...
  render: (arguments_) => <BaseBadge {...arguments_}>Label</BaseBadge>,
