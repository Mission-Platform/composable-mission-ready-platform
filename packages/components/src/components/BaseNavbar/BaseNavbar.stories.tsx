...
import BaseNavbarItem from '../BaseNavbarItem/BaseNavbarItem.vue'
...
export const WithNestedItems: Story = {
  ...
  render: (args) => ({
    ...
    setup() {
      ...
      return { args, servicesChildren, resourcesChildren }
    },
    template: `
      <BaseNavbar v-bind="args">
        <BaseNavbarItem label="Home" active />
