...
import styles from './base-responsive-video.module.scss';
 ...
 * {@link BaseBackgroundVideo}. It owns its styling through the co-located CSS
 * Module `base-responsive-video.module.scss`, assembled with the
...
export function BaseResponsiveVideo(properties: ResponsiveVideoProperties): MpElement {
  ...
  const className = classNames(styles['base-responsive-video'], sizeStyles[`base-size--${size}`], {
    [styles['base-responsive-video--rounded']]: rounded,
  });
