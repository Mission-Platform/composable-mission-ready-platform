...
describe('BaseRadioGroup', () => {
  ...
  it('applies vertical direction class by default', () => {
    const wrapper = mount(BaseRadioGroup, { props: { options: OPTIONS } })
    expect(wrapper.find('.base-radio-group__options').classes()).toContain(
      'base-radio-group__options--vertical',
    )
  })
  ...
  it('applies horizontal direction class', () => {
    ...
    expect(wrapper.find('.base-radio-group__options').classes()).toContain(
      'base-radio-group__options--horizontal',
    )
  })
  ...
  it('renders legend visually hidden when legendHidden is true', () => {
    const wrapper = mount(BaseRadioGroup, { props: { options: OPTIONS, legend: 'Hidden Legend', legendHidden: true } })
