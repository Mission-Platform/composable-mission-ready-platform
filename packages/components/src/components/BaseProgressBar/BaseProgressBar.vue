  ...
  .base-progress-bar {
    ...
    &__track {
      ...
      &--success::-webkit-progress-value {
        background-color: var(--mp-color-success-default);
        border-radius: var(--mp-radius-full);
      }
      ...
      &--warning::-webkit-progress-value {
        background-color: var(--mp-color-warning-default);
        border-radius: var(--mp-radius-full);
      }

      &--info::-webkit-progress-value {
        background-color: var(--mp-color-info-default);
        border-radius: var(--mp-radius-full);
      }
    ...
    /* Sizes */
    &--sm .base-progress-bar__track {
      height: 4px;
    }

    &--md .base-progress-bar__track {
      height: 8px;
    }

    &--lg .base-progress-bar__track {
      height: 12px;
    }
  }
