...
import BaseTimeRangeInput from './BaseTimeRangeInput.vue'
import type { TimeRange } from './BaseTimeRangeInput.vue'
...
const meta = {
  ...
  render: (args) => ({
    ...
    setup() {
      const range = ref<TimeRange>(args.modelValue ?? { start: '', end: '' })
      return { args, range }
    },
