...
import { BaseTimeInput } from './base-time-input';

/**
 * Exercises the **neutral** `BaseTimeInput` authored in this package, rendering
 ...
 */
const ReactTimeInput = toReactComponent(BaseTimeInput, 'TimeInput');
const VueTimeInput = toVueComponent(BaseTimeInput, 'TimeInput');

describe('BaseTimeInput authors the same component for React and Vue', () => {
