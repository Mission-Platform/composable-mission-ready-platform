<script lang="ts" setup>
  /**
   * `BaseTimeInput` — Time input component for the Mission Platform UI.
   *
...
<template>
  ...
  >
    ...
    <div class="base-time-input__wrapper">
      <!-- Leading extension (e.g. an icon, unit, or button). -->
      <span
        v-if="$slots.start"
        class="base-time-input__extension base-time-input__extension--start"
      >
        <slot name="start" />
      </span>
      <button
      ...
      <span
        v-if="$slots.end"
        class="base-time-input__extension base-time-input__extension--end"
      >
        <slot name="end" />
      </span>
    </div>
...
<style lang="scss" scoped>
  ...
  @layer mp.components {
    .base-time-input {
      ...
      &--error .base-time-input__wrapper {
