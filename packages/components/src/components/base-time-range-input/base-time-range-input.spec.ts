...
import { BaseTimeRangeInput } from './base-time-range-input';

/**
 * Exercises the **neutral** `BaseTimeRangeInput` authored in this package,
 ...
 */
const ReactTimeRangeInput = toReactComponent(BaseTimeRangeInput, 'TimeRangeInput');
const VueTimeRangeInput = toVueComponent(BaseTimeRangeInput, 'TimeRangeInput');

describe('BaseTimeRangeInput authors the same component for React and Vue', () => {
