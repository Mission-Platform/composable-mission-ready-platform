...
import { BaseSegmentControl, type SegmentOption } from './base-segment-control';

/**
 * Exercises the **neutral** `BaseSegmentControl` authored in this package,
 ...
 * `tabindex`.
 */
const ReactSegmentControl = toReactComponent(BaseSegmentControl, 'SegmentControl');
const VueSegmentControl = toVueComponent(BaseSegmentControl, 'SegmentControl');
...
describe('BaseSegmentControl authors the same component for React and Vue', () => {
