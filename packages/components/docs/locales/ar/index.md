...
تم تأليف هذه المكتبة مرة واحدة باستخدام لهجة JSX محايدة للإطار (عبر `@mission-platform/forge`) ثم تم تجميعها في
...
- **مصدر محايد**: تتم كتابة المكونات في ملفات `.tsx` باستخدام `@mission-platform/forge`.
