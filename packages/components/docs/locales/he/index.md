...
ספרייה זו נכתבה פעם אחת באמצעות ניב JSX ניטרלי במסגרת (דרך `@mission-platform/forge`) ולאחר מכן הידור בכתובת
...
- **מקור ניטרלי**: רכיבים נכתבים בקבצי `.tsx` באמצעות `@mission-platform/forge`.
