import { c as e, t, u as n } from "./editor.api2-BNt2jrne.js";
...
function _() {
	return import("./tsMode-C4b0QZx3.js");
}
e.onLanguage("typescript", () => _().then((e) => e.setupTypeScript(p))), e.onLanguage("javascript", () => _().then((e) => e.setupJavaScript(m)));
//#endregion
