import { BaseButton, BaseModal, type ModalSize } from '@mission-platform/components';
...
import styles from './base-schema-form-dialog.module.scss';
...
/**
 * `BaseSchemaFormDialog` — a {@link BaseSchemaForm} hosted inside a
 * {@link BaseModal}, authored once in the neutral JSX dialect and compiled
 ...
 */
export function BaseSchemaFormDialog(properties: Readonly<SchemaFormDialogProperties>): MpElement {
  const {
    open = false,
    title,
    schema,
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={styles['base-schema-form-dialog__actions']}
          slot="actions"
        >
          <BaseButton
            disabled={disabled}
