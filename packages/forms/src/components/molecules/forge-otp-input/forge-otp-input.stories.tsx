...
import { ForgeOtpInput } from '@mission-platform/forms';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeOtpInput` is the write-once `ForgeOtpInput` component of `@mission-platform/forms`. `length` single-character cells bound to one
