...
import { ForgeNumberStepper } from '@mission-platform/forms';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeNumberStepper` is the write-once `ForgeNumberStepper` component of `@mission-platform/forms`
 * in `@mission-platform/forms`. A number field flanked by −/+ buttons; the
