...
/**
 * `ForgeSegmentControl` is the write-once `ForgeSegmentControl` component of `@mission-platform/forms`
 * in `@mission-platform/forms`. It presents mutually exclusive `options` as
