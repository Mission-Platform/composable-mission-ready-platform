...
import { BaseSchemaFormDialog } from './base-schema-form-dialog';

import type { SchemaFormDefinition } from '../base-schema-form';

/**
 * Exercises the **neutral** `BaseSchemaFormDialog` authored in this package,
 ...
 */
const ReactDialog = toReactComponent(BaseSchemaFormDialog, 'SchemaFormDialog');
const VueDialog = toVueComponent(BaseSchemaFormDialog, 'SchemaFormDialog');
...
describe('BaseSchemaFormDialog authors the same component for React and Vue', () => {
