...
import { BaseSchemaForm, type SchemaFormDefinition } from './base-schema-form';

/**
 * Exercises the **neutral** `BaseSchemaForm` authored in this package, rendering
 ...
 */
const ReactSchemaForm = toReactComponent(BaseSchemaForm, 'SchemaForm');
const VueSchemaForm = toVueComponent(BaseSchemaForm, 'SchemaForm');
...
describe('BaseSchemaForm authors the same component for React and Vue', () => {
