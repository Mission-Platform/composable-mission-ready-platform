...
| 이름   | 유형                    | 설명                                         |
| ------ | ----------------------- | -------------------------------------------- |
| 목표   | 알 수 없음              | - 유효성을 검사할 대상 개체 또는 기록입니다. |
| 스키마 | 선언적 스키마           | - 구조적 규칙을 정의하는 선언적 스키마.      |
| 옵션   | 스키마 유효성 검사 옵션 | - 유효성 검사 구성 옵션.                     |

#### 계약

- **@param:** - 유효성을 검사할 대상 개체 또는 레코드입니다.
- **@param:** - 구조적 규칙을 정의하는 선언적 스키마입니다.
- **@param:** - 유효성 검사 구성 옵션입니다.
- **@returns:** 수집된 유효성 검사 문제의 배열입니다.
