...
`packages/compiler/forge/forge-web-script/src/fixtures/stateful-memory.fws` is de conformiteit
...
`packages/compiler/forge/forge-web-script/src/fixtures/bootstrap.ts` is het uitvoerbare bestand
...
`packages/compiler/forge/forge-web-script/src/fixtures/codec-migration.ts` is de eerste
