...
`packages/compiler/forge/forge-web-script/src/fixtures/stateful-memory.fws` est la conformité
...
`packages/compiler/forge/forge-web-script/src/fixtures/bootstrap.ts` est l'exécutable
...
`packages/compiler/forge/forge-web-script/src/fixtures/codec-migration.ts` est le premier
