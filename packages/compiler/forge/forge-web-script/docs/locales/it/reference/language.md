...
`packages/compiler/forge/forge-web-script/src/fixtures/stateful-memory.fws` è la conformità
...
`packages/compiler/forge/forge-web-script/src/fixtures/bootstrap.ts` è l'eseguibile
...
`packages/compiler/forge/forge-web-script/src/fixtures/codec-migration.ts` è il primo
