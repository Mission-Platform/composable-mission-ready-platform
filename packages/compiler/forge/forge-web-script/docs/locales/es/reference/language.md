...
> packages/compiler/forge/forge-web-script/docs/reference/language.md: [packages/compiler/forge/forge-web-script/docs/reference/language.md](../../../reference/language.md)
> Idioma: Español (es)
...
`packages/compiler/forge/forge-web-script/src/fixtures/stateful-memory.fws` es la conformidad
...
`packages/compiler/forge/forge-web-script/src/fixtures/bootstrap.ts` es el ejecutable
...
`packages/compiler/forge/forge-web-script/src/fixtures/codec-migration.ts` es el primero
