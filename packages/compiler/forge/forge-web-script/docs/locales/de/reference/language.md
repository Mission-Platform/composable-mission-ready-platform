...
`packages/compiler/forge/forge-web-script/src/fixtures/stateful-memory.fws` ist die Konformität
...
`packages/compiler/forge/forge-web-script/src/fixtures/bootstrap.ts` ist die ausführbare Datei
...
`packages/compiler/forge/forge-web-script/src/fixtures/codec-migration.ts` ist der erste
