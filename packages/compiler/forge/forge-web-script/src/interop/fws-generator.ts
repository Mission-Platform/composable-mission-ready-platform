...
export class FwsBindingGenerator {
  ...
  private readonly options: FwsBindingOptions;

  public constructor(module: WebIdlModule, options: FwsBindingOptions = {}) {
    this.module = module;
  ...
  public generate(): string {
    const lines: string[] = [
      '// Generated by Forge Web Script Web IDL Interop Compiler',
...
export function generateFwsBindings(module: WebIdlModule, options?: FwsBindingOptions): string {
  return new FwsBindingGenerator(module, options).generate();
}
