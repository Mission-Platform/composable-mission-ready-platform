...
| -------------------- | ------------------------------- |
| QR                   | `packages/qr-code/src/fws`      |
| Data Matrix          | `packages/matrix-code/src/fws`  |
| Aztec (compact)      | `packages/matrix-code/src/fws`  |
| 1D barcode           | `packages/barcode/src/fws`      |
| PDF417               | `packages/code-scanner/src/fws` |
| GS1 DataBar (RSS-14) | `packages/code-scanner/src/fws` |
| MaxiCode             | `packages/code-scanner/src/fws` |
