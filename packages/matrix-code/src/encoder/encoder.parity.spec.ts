...
const GOLDEN_VECTORS: readonly GoldenVector[] = [
  ...
  },
  {
    ...
    width: 16,
    height: 16,
    modules: '',
  },
  {
    ...
    width: 18,
    height: 8,
    modules: '101010101010101010110010000011000001110001001101111010110011000100011101111101100111001000101111000100010111100001111011011010111111111111111111',
  },
  {
    symbology: 'aztec',
    data: 'A',
    width: 15,
    height: 15,
    modules: '000110011100001111101101011101111100000010110101111111111111001100000001110001101111101100100101000101111100101010101111000101000101011001101111101100111100000001101110111111111111100000101000010001010111101110010010110001110',
  },
  {
    symbology: 'aztec',
    data: 'HELLO',
    width: 15,
    height: 15,
    modules: '001110111101011111000001100000111100001000101101111111111100000100000001001100101111101001100101000101100101101010101100011101000101101001101111101001000100000001111100111111111110000001010010001000100010001101111010101010111',
  },
];
