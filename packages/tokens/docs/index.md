...
- [Build and test guide](guides/development.md) — token source, generation, and
  stylesheet checks.
- [`README.md`](../README.md) — package exports and basic setup.

Import the package's public `.` or SCSS subpaths from `package.json`; do not
copy generated token files into an application.
