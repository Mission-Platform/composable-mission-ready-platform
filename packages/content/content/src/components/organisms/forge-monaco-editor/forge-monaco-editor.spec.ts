 ...
 */
const ReactMonacoEditor = toReactComponent(ForgeMonacoEditor, 'MonacoEditor');
const VueMonacoEditor = toVueComponent(ForgeMonacoEditor, 'MonacoEditor');

describe('ForgeMonacoEditor authors the same component for React and Vue', () => {
