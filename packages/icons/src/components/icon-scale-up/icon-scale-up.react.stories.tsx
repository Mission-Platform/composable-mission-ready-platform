import { IconScaleUp } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconScaleUp` is the React build of the cross-framework icon
 * `IconScaleUp` in `@mission-platform/icons`, authored once in the neutral JSX
