...
import styles from './icon-share.module.scss';
...
/**
 * `IconShare` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-share.module.scss`.
 */
export function IconShare(properties: Readonly<IconShareProperties>): MpElement {
