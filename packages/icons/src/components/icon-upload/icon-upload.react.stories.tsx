import { IconUpload } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconUpload` is the React build of the cross-framework icon
 * `IconUpload` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Actions/IconUpload',
