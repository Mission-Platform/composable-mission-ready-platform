...
import IconUpload from './Icon.vue'

describe('IconUpload', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconUpload)
    expect(wrapper.exists()).toBe(true)
  })

  it('applies size prop', () => {
    const wrapper = mount(IconUpload, { props: { size: 32 } })
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconUpload, { props: { ariaLabel: 'Test label' } })
    const svg = wrapper.find('svg')
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconUpload, { props: { ariaLabel: undefined } })
    const svg = wrapper.find('svg')
