...
import styles from './icon-chat.module.scss';

export interface IconChatProperties extends MpProperties {
...
/**
 * `IconChat` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-chat.module.scss`.
 */
export function IconChat(properties: Readonly<IconChatProperties>): MpElement {
