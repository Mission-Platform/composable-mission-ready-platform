import { IconChat } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconChat` is the React build of the cross-framework icon
 * `IconChat` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Communication/IconChat',
  component: IconChat,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof IconChat>;
