...
import IconChat from './icon.vue';

describe('IconChat', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconChat);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconChat, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconChat, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconChat, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
