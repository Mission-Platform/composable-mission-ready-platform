import { IconDownload } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconDownload` is the React build of the cross-framework icon
 * `IconDownload` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Actions/IconDownload',
...
} satisfies Meta<typeof IconDownload>;
