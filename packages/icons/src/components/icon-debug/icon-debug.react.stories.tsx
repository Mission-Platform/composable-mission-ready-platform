import { IconDebug } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconDebug` is the React build of the cross-framework icon
 * `IconDebug` in `@mission-platform/icons`, authored once in the neutral JSX
