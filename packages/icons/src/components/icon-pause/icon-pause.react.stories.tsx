import { IconPause } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconPause` is the React build of the cross-framework icon
 * `IconPause` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconPause',
  component: IconPause,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof IconPause>;
