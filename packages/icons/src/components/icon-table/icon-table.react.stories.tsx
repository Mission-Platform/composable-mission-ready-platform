import { IconTable } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconTable` is the React build of the cross-framework icon
 * `IconTable` in `@mission-platform/icons`, authored once in the neutral JSX
