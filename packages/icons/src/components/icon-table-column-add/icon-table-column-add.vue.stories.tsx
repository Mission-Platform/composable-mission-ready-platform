import { IconTableColumnAdd } from '@mission-platform/icons/vue';

import type { Meta, StoryObj } from '@storybook/vue3-vite';

/**
 * `IconTableColumnAdd` is the Vue 3 build of the cross-framework icon
 ...
 */
const meta = {
  title: 'Icons/Table/IconTableColumnAdd',
  component: IconTableColumnAdd,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof IconTableColumnAdd>;
