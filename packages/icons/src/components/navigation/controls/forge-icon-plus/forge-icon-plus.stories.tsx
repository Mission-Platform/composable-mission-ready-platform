...
/**
 * `ForgeIconPlus` is a cross-framework icon
 * `ForgeIconPlus` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/navigation/controls/forge-icon-plus',
  component: ForgeIconPlus,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconPlus>;
