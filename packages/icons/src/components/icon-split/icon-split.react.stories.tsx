import { IconSplit } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconSplit` is the React build of the cross-framework icon
 * `IconSplit` in `@mission-platform/icons`, authored once in the neutral JSX
