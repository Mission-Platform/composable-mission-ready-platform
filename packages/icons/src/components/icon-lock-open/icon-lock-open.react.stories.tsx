import { IconLockOpen } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconLockOpen` is the React build of the cross-framework icon
 * `IconLockOpen` in `@mission-platform/icons`, authored once in the neutral JSX
