import { IconWrench } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconWrench` is the React build of the cross-framework icon
 * `IconWrench` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconWrench',
...
} satisfies Meta<typeof IconWrench>;
