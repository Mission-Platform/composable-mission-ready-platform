...
describe('IconMapPin', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconMapPin);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconMapPin, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconMapPin, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconMapPin, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
