...
describe('IconAlignCenter', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconAlignCenter);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconAlignCenter, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconAlignCenter, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconAlignCenter, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
