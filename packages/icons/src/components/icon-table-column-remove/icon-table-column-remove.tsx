...
import styles from './icon-table-column-remove.module.scss';
...
/**
 * `IconTableColumnRemove` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-table-column-remove.module.scss`.
 */
export function IconTableColumnRemove(properties: Readonly<IconTableColumnRemoveProperties>): MpElement {
