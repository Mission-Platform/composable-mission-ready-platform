...
describe('IconAlignLeft', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconAlignLeft)
    expect(wrapper.exists()).toBe(true)
  })

  it('applies size prop', () => {
    const wrapper = mount(IconAlignLeft, { props: { size: 32 } })
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconAlignLeft, { props: { ariaLabel: 'Test label' } })
    const svg = wrapper.find('svg')
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconAlignLeft, { props: { ariaLabel: undefined } })
    const svg = wrapper.find('svg')
