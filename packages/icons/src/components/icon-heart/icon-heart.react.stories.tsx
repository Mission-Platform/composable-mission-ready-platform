import { IconHeart } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconHeart` is the React build of the cross-framework icon
 * `IconHeart` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconHeart',
  component: IconHeart,
  tags: ['autodocs'],
  argTypes: {
