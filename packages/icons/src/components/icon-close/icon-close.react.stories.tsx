import { IconClose } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconClose` is the React build of the cross-framework icon
 * `IconClose` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Navigation / Controls/IconClose',
  component: IconClose,
  tags: ['autodocs'],
  argTypes: {
