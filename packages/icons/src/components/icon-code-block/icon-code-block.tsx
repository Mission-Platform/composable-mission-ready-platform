...
import styles from './icon-code-block.module.scss';
...
/**
 * `IconCodeBlock` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-code-block.module.scss`.
 */
export function IconCodeBlock(properties: Readonly<IconCodeBlockProperties>): MpElement {
