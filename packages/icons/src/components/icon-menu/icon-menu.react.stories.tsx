import { IconMenu } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconMenu` is the React build of the cross-framework icon
 * `IconMenu` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Navigation / Controls/IconMenu',
  component: IconMenu,
  tags: ['autodocs'],
  argTypes: {
