import { IconBell } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconBell` is the React build of the cross-framework icon
 * `IconBell` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconBell',
  component: IconBell,
  tags: ['autodocs'],
  argTypes: {
