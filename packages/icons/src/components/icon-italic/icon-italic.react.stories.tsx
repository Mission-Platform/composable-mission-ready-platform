import { IconItalic } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconItalic` is the React build of the cross-framework icon
 * `IconItalic` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Text Formatting/IconItalic',
...
} satisfies Meta<typeof IconItalic>;
