...
import styles from './icon-minus.module.scss';

export interface IconMinusProperties extends MpProperties {
...
/**
 * `IconMinus` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-minus.module.scss`.
 */
export function IconMinus(properties: Readonly<IconMinusProperties>): MpElement {
