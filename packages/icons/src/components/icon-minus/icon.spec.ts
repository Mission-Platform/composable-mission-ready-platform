...
import IconMinus from './icon.vue';
...
describe('IconMinus', () => {
  ...
  it('applies size prop', () => {
    const wrapper = mount(IconMinus, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconMinus, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconMinus, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
