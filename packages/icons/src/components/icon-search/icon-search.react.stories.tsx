import { IconSearch } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconSearch` is the React build of the cross-framework icon
 * `IconSearch` in `@mission-platform/icons`, authored once in the neutral JSX
