...
import IconPencil from './Icon.vue';

describe('IconPencil', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconPencil);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconPencil, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconPencil, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconPencil, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
