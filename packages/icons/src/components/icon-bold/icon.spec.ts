...
import IconBold from './icon.vue';

describe('IconBold', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconBold);
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconBold, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
