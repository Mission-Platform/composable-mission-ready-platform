...
/**
 * `IconBold` is the React build of the cross-framework icon
 * `IconBold` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Text Formatting/IconBold',
  component: IconBold,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof IconBold>;
