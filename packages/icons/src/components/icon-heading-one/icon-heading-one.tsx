...
import styles from './icon-heading-one.module.scss';
...
/**
 * `IconHeadingOne` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconHeadingOne(properties: Readonly<IconHeadingOneProperties>): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-heading-one']}>
      <svg
