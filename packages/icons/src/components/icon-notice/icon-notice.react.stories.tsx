import { IconNotice } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconNotice` is the React build of the cross-framework icon
 * `IconNotice` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/State / Status/IconNotice',
...
} satisfies Meta<typeof IconNotice>;
