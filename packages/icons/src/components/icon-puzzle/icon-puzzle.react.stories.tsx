import { IconPuzzle } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconPuzzle` is the React build of the cross-framework icon
 * `IconPuzzle` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconPuzzle',
...
} satisfies Meta<typeof IconPuzzle>;
