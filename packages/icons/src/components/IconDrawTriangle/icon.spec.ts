...
import IconDrawTriangle from './Icon.vue';

describe('IconDrawTriangle', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconDrawTriangle);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconDrawTriangle, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconDrawTriangle, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconDrawTriangle, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
