...
import styles from './icon-send.module.scss';
...
/**
 * `IconSend` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-send.module.scss`.
 */
export function IconSend(properties: Readonly<IconSendProperties>): MpElement {
