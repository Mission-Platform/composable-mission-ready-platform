...
import styles from './icon-heading-two.module.scss';
...
/**
 * `IconHeadingTwo` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconHeadingTwo(properties: Readonly<IconHeadingTwoProperties>): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-heading-two']}>
      <svg
