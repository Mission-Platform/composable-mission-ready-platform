...
import styles from './icon-lightning.module.scss';
...
/**
 * `IconLightning` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-lightning.module.scss`.
 */
export function IconLightning(properties: Readonly<IconLightningProperties>): MpElement {
