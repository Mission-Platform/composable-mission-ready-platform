import { IconCalendar } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconCalendar` is the React build of the cross-framework icon
 * `IconCalendar` in `@mission-platform/icons`, authored once in the neutral JSX
