...
describe('IconCalendar', () => {
  ...
  it('applies size prop', () => {
    const wrapper = mount(IconCalendar, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconCalendar, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconCalendar, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
