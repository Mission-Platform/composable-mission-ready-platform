...
import styles from './icon-draw-triangle.module.scss';
...
/**
 * `IconDrawTriangle` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconDrawTriangle(properties: IconDrawTriangleProperties): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-draw-triangle']}>
      <svg
