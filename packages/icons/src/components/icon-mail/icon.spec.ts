...
describe('IconMail', () => {
  ...
  it('applies size prop', () => {
    const wrapper = mount(IconMail, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconMail, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconMail, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
