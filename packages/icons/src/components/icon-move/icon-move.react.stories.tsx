import { IconMove } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconMove` is the React build of the cross-framework icon
 * `IconMove` in `@mission-platform/icons`, authored once in the neutral JSX
