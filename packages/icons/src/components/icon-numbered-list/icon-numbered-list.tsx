...
import styles from './icon-numbered-list.module.scss';
...
/**
 * `IconNumberedList` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconNumberedList(properties: IconNumberedListProperties): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-numbered-list']}>
      <svg
