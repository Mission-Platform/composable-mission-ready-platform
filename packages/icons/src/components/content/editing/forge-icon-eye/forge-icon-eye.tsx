...
import styles from './forge-icon-eye.module.scss';
 ...
 */
export function ForgeIconEye(properties: Readonly<IconEyeProperties>): MpElement {
  const size = properties.size ?? 'md';
  const sizeValue = typeof size === 'number' ? size : mapTokenToPixels(size);
  const color = properties.color ?? 'currentColor';

  return (
    <div className={styles['forge-icon-eye']}>
      <svg
