...
import styles from './icon-language.module.scss';
...
/**
 * `IconLanguage` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-language.module.scss`.
 */
export function IconLanguage(properties: Readonly<IconLanguageProperties>): MpElement {
