import { IconLanguage } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconLanguage` is the React build of the cross-framework icon
 * `IconLanguage` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconLanguage',
...
} satisfies Meta<typeof IconLanguage>;
