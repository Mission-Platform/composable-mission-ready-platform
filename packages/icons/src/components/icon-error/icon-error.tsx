...
import styles from './icon-error.module.scss';
...
/**
 * `IconError` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-error.module.scss`.
 */
export function IconError(properties: Readonly<IconErrorProperties>): MpElement {
