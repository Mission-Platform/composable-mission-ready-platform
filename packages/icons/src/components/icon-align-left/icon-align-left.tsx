...
import styles from './icon-align-left.module.scss';
...
/**
 * `IconAlignLeft` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconAlignLeft(properties: IconAlignLeftProperties): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-align-left']}>
      <svg
