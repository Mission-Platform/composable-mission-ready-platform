...
import styles from './icon-play.module.scss';
...
/**
 * `IconPlay` — a filled play (▶) triangle authored once in the neutral JSX
 * dialect.
 *
 ...
 * co-located CSS Module `icon-play.module.scss`.
 */
export function IconPlay(properties: Readonly<IconPlayProperties>): MpElement {
