import { IconPlay } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconPlay` is the React build of the cross-framework icon
 * `IconPlay` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconPlay',
  component: IconPlay,
  tags: ['autodocs'],
  argTypes: {
