...
/**
 * `IconAlert` is the React build of the cross-framework icon
 * `IconAlert` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/State / Status/IconAlert',
  component: IconAlert,
  tags: ['autodocs'],
  argTypes: {
