...
import IconHeading from './Icon.vue'
...
describe('IconHeading', () => {
  ...
  it('applies numeric size as px', () => {
    const wrapper = mount(IconHeading, { props: { size: 32 } })
  ...
  it('applies named size token', () => {
    const wrapper = mount(IconHeading, { props: { size: 'lg' } })
    expect(wrapper.find('svg').attributes('width')).toContain('mp-size-icon-lg')
  })

  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconHeading, { props: { ariaLabel: 'Test label' } })
    const svg = wrapper.find('svg')
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconHeading, { props: { ariaLabel: undefined } })
    const svg = wrapper.find('svg')
