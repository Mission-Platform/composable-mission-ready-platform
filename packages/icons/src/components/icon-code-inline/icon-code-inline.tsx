...
import styles from './icon-code-inline.module.scss';
...
/**
 * `IconCodeInline` — an icon authored once in the neutral JSX dialect.
 *
...
export function IconCodeInline(properties: Readonly<IconCodeInlineProperties>): MpElement {
  ...
  return (
    <div classNames={styles['base-icon-code-inline']}>
      <svg
