import { IconCloud } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconCloud` is the React build of the cross-framework icon
 * `IconCloud` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconCloud',
  component: IconCloud,
  tags: ['autodocs'],
  argTypes: {
