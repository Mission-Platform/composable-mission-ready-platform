import { IconSend } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconSend` is a cross-framework icon
 * `IconSend` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Communication/IconSend',
  component: IconSend,
  tags: ['autodocs'],
  argTypes: {
