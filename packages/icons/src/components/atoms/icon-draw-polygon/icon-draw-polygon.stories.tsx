import { IconDrawPolygon } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconDrawPolygon` is a cross-framework icon
 * `IconDrawPolygon` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Map/IconDrawPolygon',
