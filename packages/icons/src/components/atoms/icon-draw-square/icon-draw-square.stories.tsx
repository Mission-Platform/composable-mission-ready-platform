import { IconDrawSquare } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconDrawSquare` is a cross-framework icon
 * `IconDrawSquare` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Map/IconDrawSquare',
