import { IconUser } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconUser` is a cross-framework icon
 * `IconUser` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/General UI/IconUser',
  component: IconUser,
  tags: ['autodocs'],
  argTypes: {
