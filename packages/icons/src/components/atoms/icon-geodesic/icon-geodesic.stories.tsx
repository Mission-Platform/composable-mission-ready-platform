import { IconGeodesic } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconGeodesic` is a cross-framework icon
 * `IconGeodesic` in `@mission-platform/icons`, authored once in the neutral JSX
