import { IconFilter } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconFilter` is a cross-framework icon
 * `IconFilter` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Navigation / Controls/IconFilter',
