import { IconDrawCircle } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconDrawCircle` is a cross-framework icon
 * `IconDrawCircle` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Map/IconDrawCircle',
