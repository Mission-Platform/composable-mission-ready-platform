...
/**
 * `ForgeIconGlobe` is a cross-framework icon
 * `ForgeIconGlobe` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Navigation / Links/ForgeIconGlobe',
  component: ForgeIconGlobe,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconGlobe>;
