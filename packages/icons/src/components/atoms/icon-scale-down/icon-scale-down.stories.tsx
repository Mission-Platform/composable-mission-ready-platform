import { IconScaleDown } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconScaleDown` is a cross-framework icon
 * `IconScaleDown` in `@mission-platform/icons`, authored once in the neutral JSX
