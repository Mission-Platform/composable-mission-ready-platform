import { IconHome } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconHome` is a cross-framework icon
 * `IconHome` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Navigation / Links/IconHome',
  component: IconHome,
  tags: ['autodocs'],
  argTypes: {
