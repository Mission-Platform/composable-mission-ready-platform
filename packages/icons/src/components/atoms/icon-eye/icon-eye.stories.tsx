import { IconEye } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconEye` is a cross-framework icon
 * `IconEye` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Visibility/IconEye',
  component: IconEye,
  tags: ['autodocs'],
  argTypes: {
