import { IconError } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconError` is a cross-framework icon
 * `IconError` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/State / Status/IconError',
  component: IconError,
  tags: ['autodocs'],
  argTypes: {
