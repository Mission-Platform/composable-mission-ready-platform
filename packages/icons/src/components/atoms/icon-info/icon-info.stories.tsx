import { IconInfo } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconInfo` is a cross-framework icon
 * `IconInfo` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/State / Status/IconInfo',
  component: IconInfo,
  tags: ['autodocs'],
  argTypes: {
