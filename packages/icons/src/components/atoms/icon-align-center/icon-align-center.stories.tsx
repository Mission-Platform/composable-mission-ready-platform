import { IconAlignCenter } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconAlignCenter` is a cross-framework icon
 * `IconAlignCenter` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Text Alignment/IconAlignCenter',
