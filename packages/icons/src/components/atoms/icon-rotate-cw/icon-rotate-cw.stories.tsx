import { IconRotateCw } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconRotateCw` is a cross-framework icon
 * `IconRotateCw` in `@mission-platform/icons`, authored once in the neutral JSX
