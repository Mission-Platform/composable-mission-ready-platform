...
import styles from './icon-notice.module.scss';
...
/**
 * `IconNotice` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-notice.module.scss`.
 */
export function IconNotice(properties: Readonly<IconNoticeProperties>): MpElement {
