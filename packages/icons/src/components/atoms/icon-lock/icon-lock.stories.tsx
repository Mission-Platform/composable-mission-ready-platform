import { IconLock } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconLock` is a cross-framework icon
 * `IconLock` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/General UI/IconLock',
  component: IconLock,
  tags: ['autodocs'],
  argTypes: {
