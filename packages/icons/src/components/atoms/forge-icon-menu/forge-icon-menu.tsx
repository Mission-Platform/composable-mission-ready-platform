...
export interface IconMenuProperties extends MpProperties {
 ...
 */
export function ForgeIconMenu(properties: Readonly<IconMenuProperties>): MpElement {
  const size = properties.size ?? 'md';
  const sizeValue = typeof size === 'number' ? size : mapTokenToPixels(size);
  const color = properties.color ?? 'currentColor';

  return (
    <div className={styles['forge-icon-menu']}>
      <svg
