import { IconExternalLink } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconExternalLink` is a cross-framework icon
 * `IconExternalLink` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Navigation / Links/IconExternalLink',
