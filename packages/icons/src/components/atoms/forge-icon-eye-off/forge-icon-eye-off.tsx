...
import styles from './forge-icon-eye-off.module.scss';

export interface IconEyeOffProperties extends MpProperties {
 ...
 */
export function ForgeIconEyeOff(properties: Readonly<IconEyeOffProperties>): MpElement {
  const size = properties.size ?? 'md';
  const sizeValue = typeof size === 'number' ? size : mapTokenToPixels(size);
  const color = properties.color ?? 'currentColor';

  return (
    <div className={styles['forge-icon-eye-off']}>
      <svg
      ...
      >
        ...
        <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4C19 4 23 12 23 12A18.5 18.5 0 0 1 20.71 15.71" />
        <line
          x1={1}
          x2={23}
          y1={1}
