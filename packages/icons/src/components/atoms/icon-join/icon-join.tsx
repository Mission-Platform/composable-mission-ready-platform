...
import styles from './icon-join.module.scss';
...
/**
 * `IconJoin` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-join.module.scss`.
 */
export function IconJoin(properties: Readonly<IconJoinProperties>): MpElement {
