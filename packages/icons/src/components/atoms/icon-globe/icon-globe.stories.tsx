import { IconGlobe } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconGlobe` is a cross-framework icon
 * `IconGlobe` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Atoms/Navigation / Links/IconGlobe',
  component: IconGlobe,
  tags: ['autodocs'],
  argTypes: {
