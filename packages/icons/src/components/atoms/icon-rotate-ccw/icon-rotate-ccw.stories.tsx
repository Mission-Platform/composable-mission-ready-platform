import { IconRotateCcw } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `IconRotateCcw` is a cross-framework icon
 * `IconRotateCcw` in `@mission-platform/icons`, authored once in the neutral JSX
