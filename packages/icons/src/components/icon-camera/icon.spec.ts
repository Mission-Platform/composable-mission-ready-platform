...
import IconCamera from './icon.vue';

describe('IconCamera', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconCamera);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconCamera, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconCamera, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconCamera, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
