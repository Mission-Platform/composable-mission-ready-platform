import { IconRefresh } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconRefresh` is the React build of the cross-framework icon
 * `IconRefresh` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Actions/IconRefresh',
...
} satisfies Meta<typeof IconRefresh>;
