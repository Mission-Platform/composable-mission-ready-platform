...
describe('IconLink', () => {
  ...
  it('applies size prop', () => {
    const wrapper = mount(IconLink, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconLink, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconLink, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
