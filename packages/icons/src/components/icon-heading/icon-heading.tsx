...
/**
 * `IconHeading` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-heading.module.scss`.
 */
export function IconHeading(properties: Readonly<IconHeadingProperties>): MpElement {
