import { IconQrCode } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconQrCode` is the React build of the cross-framework icon
 * `IconQrCode` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/General UI/IconQrCode',
...
} satisfies Meta<typeof IconQrCode>;
