...
import styles from './icon-external-link.module.scss';
...
/**
 * `IconExternalLink` — an icon authored once in the neutral JSX dialect.
 *
 ...
 * co-located CSS Module `icon-external-link.module.scss`.
 */
export function IconExternalLink(properties: Readonly<IconExternalLinkProperties>): MpElement {
