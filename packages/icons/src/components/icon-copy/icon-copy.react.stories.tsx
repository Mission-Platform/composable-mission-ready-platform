import { IconCopy } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconCopy` is the React build of the cross-framework icon
 * `IconCopy` in `@mission-platform/icons`, authored once in the neutral JSX
