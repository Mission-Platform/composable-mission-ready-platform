...
import IconAlignJustify from './Icon.vue';

describe('IconAlignJustify', () => {
  it('renders without errors', () => {
    const wrapper = mount(IconAlignJustify);
    expect(wrapper.exists()).toBe(true);
  });

  it('applies size prop', () => {
    const wrapper = mount(IconAlignJustify, { props: { size: 32 } });
  ...
  it('applies ariaLabel when provided', () => {
    const wrapper = mount(IconAlignJustify, { props: { ariaLabel: 'Test label' } });
    const svg = wrapper.find('svg');
  ...
  it('hides from a11y when ariaLabel is undefined', () => {
    const wrapper = mount(IconAlignJustify, { props: { ariaLabel: undefined } });
    const svg = wrapper.find('svg');
