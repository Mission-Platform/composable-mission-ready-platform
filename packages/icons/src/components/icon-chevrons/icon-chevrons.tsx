...
import styles from './icon-chevrons.module.scss';

/** The direction the double chevron points. */
export type IconChevronsDirection = 'up' | 'right' | 'down' | 'left';

export interface IconChevronsProperties extends MpProperties {
...
/**
 * `IconChevrons` — a directional double chevron (« ») authored once in the
 ...
 * co-located CSS Module `icon-chevrons.module.scss`.
 */
export function IconChevrons(properties: Readonly<IconChevronsProperties>): MpElement {
