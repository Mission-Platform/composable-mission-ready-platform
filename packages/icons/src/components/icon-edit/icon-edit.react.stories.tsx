import { IconEdit } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconEdit` is the React build of the cross-framework icon
 * `IconEdit` in `@mission-platform/icons`, authored once in the neutral JSX
