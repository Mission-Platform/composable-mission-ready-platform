 ...
 * `toolbar` slot.
 */
export function ForgeMapDraw(properties: Readonly<MapDrawProperties>): MpElement {
  const {
    mode,
    modelValue = [],
    geodesic = true,
  ...
  return (
    <>
      ...
      >
        ...
        />
        <ForgeMapLayer layer={{ id: 'map-draw-line', type: 'line', source: 'map-draw-committed', paint: linePaint }} />
      </ForgeMapSource>
