...
const meta = {
  title: 'Molecules/Mapping/ForgeMapDraw',
  component: ForgeMapDraw,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
...
} satisfies Meta<typeof ForgeMapDraw>;
 ...
 * `@mission-platform/components` `ForgeButton`s and receives the live `drawing`
