...
import { MapLibre, MapPopup } from '@mission-platform/map';
...
const meta = {
  title: 'Molecules/Mapping/MapPopup',
  component: MapPopup,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          '`MapPopup` anchors a MapLibre popup to a `lngLat` on the nearest `<MapLibre>` ancestor. It renders no DOM of its own — the popup lives on the map canvas and stays pinned to its coordinate as the map moves.',
      },
    },
  },
