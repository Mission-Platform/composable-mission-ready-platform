...
/**
 * `BaseContainer` — a page/section layout primitive that constrains and centres
...
export function BaseContainer(properties: ContainerProperties): MpElement {
  ...
  const className = classNames(
    'base-container',
    `base-container--${variant}`,
    variant === 'responsive' ? styles['base-container--responsive'] : undefined,
