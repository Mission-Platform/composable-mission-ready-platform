...
/** Named size scale for the side columns (mirrors `BaseDrawer`'s `DrawerSize`). */
...
/** Inline-column track width (rem) for each named size (mirrors `BaseDrawer`'s sizes). */
 ...
 * {@link BaseDrawer} (from `@mission-platform/components/base-drawer`): at/above
 ...
 *
 * It owns its styling through the co-located `base-vertical-layout.module.scss`
