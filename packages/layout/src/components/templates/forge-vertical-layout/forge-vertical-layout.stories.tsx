...
/**
 * `ForgeVerticalLayout` arranges an optional `start` column, the main content
 ...
 */
const meta = {
  title: 'Templates/Layout/ForgeVerticalLayout',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Cross-framework `ForgeVerticalLayout` — authored once in the neutral JSX dialect and shipped to both Vue 3 and React. It arranges an optional `start` column, the main content (default slot), and an optional `end` column, each backed by an inline `Drawer`: fixed-open grid tracks at/above `breakpoint`, collapsing to overlay drawers below it. The neutral dialect drops the original SFC scoped default slot and drawer drag-resize.',
      },
    },
  },
  argTypes: {
