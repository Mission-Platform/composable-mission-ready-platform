 ...
 * primitives for data-entry screens (React build).
 *
 ...
 * arranges the fields with token-driven inline CSS grids. Presentational only —
 * they render plain token-styled markup inside the cross-framework `Container`.
 */
const meta = {
...
const FIELD: CSSProperties = { display: 'flex', flexDirection: 'column', gap: 'var(--mp-spacing-1)' };
const LABEL: CSSProperties = { fontSize: 'var(--mp-size-font-sm)', color: 'var(--mp-color-text-secondary)' };
