...
const CONTENT: CSSProperties = { paddingBlock: 'var(--mp-spacing-6)', background: 'var(--mp-color-bg-base)' };
...
const KPI_LABEL: CSSProperties = { fontSize: 'var(--mp-size-font-sm)', color: 'var(--mp-color-text-secondary)' };
const KPI_VALUE: CSSProperties = {
  fontSize: 'var(--mp-size-font-2xl)',
  fontWeight: 600,
  marginTop: 'var(--mp-spacing-1)',
};
