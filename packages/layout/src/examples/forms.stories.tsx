...
import { Container } from '@mission-platform/layouts';
...
const ACTIONS = { display: 'flex', justifyContent: 'flex-end', gap: 'var(--mp-spacing-3)', marginTop: 'var(--mp-spacing-6)' };
const PRIMARY = {
    ...
    <div style={PAGE}>
      <Container variant="fixed" maxWidth="md">
        <form style={CARD}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(14rem, 1fr))', gap: 'var(--mp-spacing-4)' }}>
            ...
            <label style={{ ...FIELD, gridColumn: '1 / -1' }}><span style={LABEL}>Bio</span><span style={{ ...INPUT, height: '5rem' }}></span></label>
          </div>
          <div style={ACTIONS}>
...
export const Wizard: Story = {
  render: () => (
    <div style={PAGE}>
      <Container variant="fixed" maxWidth="md">
        <ol style={{ display: 'flex', gap: 'var(--mp-spacing-2)', listStyle: 'none', padding: 0, margin: '0 0 var(--mp-spacing-5)' }}>
          <li style={{ flex: 1, padding: 'var(--mp-spacing-2)', textAlign: 'center', borderRadius: 'var(--mp-radius-sm)', background: 'var(--mp-color-primary-default)', color: 'var(--mp-color-text-on-primary)' }}>1. Account</li>
          <li style={{ flex: 1, padding: 'var(--mp-spacing-2)', textAlign: 'center', borderRadius: 'var(--mp-radius-sm)', background: 'var(--mp-color-bg-surface)', border: '1px solid var(--mp-color-border-default)', color: 'var(--mp-color-text-secondary)' }}>2. Billing</li>
          <li style={{ flex: 1, padding: 'var(--mp-spacing-2)', textAlign: 'center', borderRadius: 'var(--mp-radius-sm)', background: 'var(--mp-color-bg-surface)', border: '1px solid var(--mp-color-border-default)', color: 'var(--mp-color-text-secondary)' }}>3. Review</li>
        </ol>
        <form style={CARD}>
