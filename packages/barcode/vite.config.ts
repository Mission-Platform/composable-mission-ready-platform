...
/** The per-framework `BaseBarcode` component build (`dist/react`, `dist/vue`, `dist/solid`, `dist/svelte`, `dist/web-components`). */
function defineFrameworkConfig(framework: JsxFramework): UserConfig {
  ...
  return defineLibraryConfig({
    rootDir: __dirname,
    name: `MissionPlatformBarcode${frameworkSuffix}`,
    entry,
    ...
    external: [...frameworkExternals, '@mission-platform/barcode'],
    overrides: {
      build: {
