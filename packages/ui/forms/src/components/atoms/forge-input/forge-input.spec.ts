...
import { ForgeInput } from './forge-input';

/**
 * Exercises the **neutral** `ForgeInput` authored in this package, rendering it
 ...
 */
const ReactInput = toReactComponent(ForgeInput, 'Input');
const VueInput = toVueComponent(ForgeInput, 'Input');

describe('ForgeInput authors the same component for React and Vue', () => {
