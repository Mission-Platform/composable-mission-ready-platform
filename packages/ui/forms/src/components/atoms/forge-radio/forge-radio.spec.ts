...
import { ForgeRadio } from './forge-radio';

/**
 * Exercises the **neutral** `ForgeRadio` authored in this package, rendering it
 ...
 */
const ReactRadio = toReactComponent(ForgeRadio, 'Radio');
const VueRadio = toVueComponent(ForgeRadio, 'Radio');

describe('ForgeRadio authors the same component for React and Vue', () => {
