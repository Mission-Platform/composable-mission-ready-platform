...
import { ForgeCheckbox } from './forge-checkbox';

/**
 * Exercises the **neutral** `ForgeCheckbox` authored in this package, rendering
 ...
 */
const ReactCheckbox = toReactComponent(ForgeCheckbox, 'Checkbox');
const VueCheckbox = toVueComponent(ForgeCheckbox, 'Checkbox');

describe('ForgeCheckbox authors the same component for React and Vue', () => {
