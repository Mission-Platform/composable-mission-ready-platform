...
import { ForgeTextarea } from './forge-textarea';

/**
 * Exercises the **neutral** `ForgeTextarea` authored in this package, rendering
 ...
 */
const ReactTextarea = toReactComponent(ForgeTextarea, 'Textarea');
const VueTextarea = toVueComponent(ForgeTextarea, 'Textarea');

describe('ForgeTextarea authors the same component for React and Vue', () => {
