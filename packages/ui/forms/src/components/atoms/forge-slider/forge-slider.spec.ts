...
import { ForgeSlider } from './forge-slider';

/**
 * Exercises the **neutral** `ForgeSlider` authored in this package, rendering it
 ...
 */
const ReactSlider = toReactComponent(ForgeSlider, 'Slider');
const VueSlider = toVueComponent(ForgeSlider, 'Slider');

describe('ForgeSlider authors the same component for React and Vue', () => {
