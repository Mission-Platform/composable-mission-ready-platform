...
import { ForgeColorInput } from './forge-color-input';

/**
 * Exercises the **neutral** `ForgeColorInput` authored in this package, rendering
 ...
 */
const ReactColorInput = toReactComponent(ForgeColorInput, 'ColorInput');
const VueColorInput = toVueComponent(ForgeColorInput, 'ColorInput');

describe('ForgeColorInput authors the same component for React and Vue', () => {
