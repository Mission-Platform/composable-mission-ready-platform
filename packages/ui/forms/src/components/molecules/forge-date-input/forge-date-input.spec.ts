...
import { ForgeDateInput } from './forge-date-input';

/**
 * Exercises the **neutral** `ForgeDateInput` authored in this package, rendering
 ...
 */
const ReactDateInput = toReactComponent(ForgeDateInput, 'DateInput');
const VueDateInput = toVueComponent(ForgeDateInput, 'DateInput');

describe('ForgeDateInput authors the same component for React and Vue', () => {
