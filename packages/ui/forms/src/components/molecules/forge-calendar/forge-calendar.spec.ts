...
/**
 * Exercises the **neutral** `ForgeCalendar` authored in this package, rendering
 ...
 */
const ReactCalendar = toReactComponent(ForgeCalendar, 'Calendar');
const VueCalendar = toVueComponent(ForgeCalendar, 'Calendar');

describe('ForgeCalendar authors the same component for React and Vue', () => {
