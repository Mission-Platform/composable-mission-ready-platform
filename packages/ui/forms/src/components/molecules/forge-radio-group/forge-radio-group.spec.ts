...
import { ForgeRadioGroup } from './forge-radio-group';
...
const VueRadioGroup = toVueComponent(ForgeRadioGroup, 'RadioGroup');
...
describe('ForgeRadioGroup authors the same component for React and Vue', () => {
