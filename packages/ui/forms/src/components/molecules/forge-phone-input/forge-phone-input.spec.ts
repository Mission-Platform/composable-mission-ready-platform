...
import { ForgePhoneInput } from './forge-phone-input';
 ...
 */
const ReactPhoneInput = toReactComponent(ForgePhoneInput, 'PhoneInput');
const VuePhoneInput = toVueComponent(ForgePhoneInput, 'PhoneInput');
...
describe('ForgePhoneInput authors the same component for React and Vue', () => {
