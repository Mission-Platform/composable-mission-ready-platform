 ...
 * `ForgePhoneInput`, built on `@mission-platform/phone-number` — the platform's
 ...
 * `@mission-platform/forge-jsx` primitives and no JSX, so `@mission-platform/vite-plugin-forge`
 ...
 * never throws.
 */
import { getPhoneNumberUtilSync, PhoneNumberFormat, type PhoneNumberUtil } from '@mission-platform/phone-number';
