...
/**
 * Exercises the **neutral** `ForgeDateTimeRangeInput` authored in this package,
 ...
 */
const ReactDateTimeRangeInput = toReactComponent(ForgeDateTimeRangeInput, 'DateTimeRangeInput');
const VueDateTimeRangeInput = toVueComponent(ForgeDateTimeRangeInput, 'DateTimeRangeInput');

describe('ForgeDateTimeRangeInput authors the same component for React and Vue', () => {
