export interface FlintRenderWorkerWasmExports {
  ...
  readonly font_get_glyph_hori_bearing_x?: (idx: number) => number;
  readonly font_get_glyph_hori_bearing_y?: (idx: number) => number;
  readonly font_get_glyph_vert_advance?: (idx: number) => number;
  readonly font_get_glyph_vert_bearing_x?: (idx: number) => number;
  readonly font_get_glyph_vert_bearing_y?: (idx: number) => number;
  readonly font_get_glyph_bbox_min_x?: (idx: number) => number;
  readonly font_get_glyph_bbox_max_x?: (idx: number) => number;
  readonly font_get_glyph_bbox_min_y?: (idx: number) => number;
  readonly font_get_glyph_bbox_max_y?: (idx: number) => number;
  readonly font_get_glyph_metrics?: (idx: number, outPtr: number) => void;
