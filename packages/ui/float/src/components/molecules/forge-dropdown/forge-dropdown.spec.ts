...
/**
 * Exercises the **neutral** `ForgeDropdown` authored in this package, rendering
 ...
 */
const ReactDropdown = toReactComponent(ForgeDropdown, 'Dropdown');
const VueDropdown = toVueComponent(ForgeDropdown, 'Dropdown');

describe('ForgeDropdown authors the same component for React and Vue', () => {
  it('teleports the trigger-anchored panel when open on both frameworks', async () => {
    ...
    for (const html of [react, vue]) {
      ...
      expect(html).toContain(sizeStyles['forge-size--md']);
