...
/**
 * Exercises the **neutral** `ForgeTooltip` authored in this package, rendering it
 ...
 */
const ReactTooltip = toReactComponent(ForgeTooltip, 'Tooltip');
const VueTooltip = toVueComponent(ForgeTooltip, 'Tooltip');

describe('ForgeTooltip authors the same component for React and Vue', () => {
