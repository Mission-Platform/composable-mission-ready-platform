...
import { ForgeVirtualTreeView, type TreeNode } from './forge-virtual-tree-view';

/**
 * Exercises the **neutral** `ForgeVirtualTreeView` authored in this package,
 ...
 */
const ReactTree = toReactComponent(ForgeVirtualTreeView, 'VirtualTreeView');
const VueTree = toVueComponent(ForgeVirtualTreeView, 'VirtualTreeView');
...
describe('ForgeVirtualTreeView authors the same component for React and Vue', () => {
