...
import { ForgeVirtualTable, type VirtualTableColumn } from './forge-virtual-table';

/**
 * Exercises the **neutral** `ForgeVirtualTable` authored in this package,
 ...
 */
const ReactTable = toReactComponent(ForgeVirtualTable, 'VirtualTable');
const VueTable = toVueComponent(ForgeVirtualTable, 'VirtualTable');
...
describe('ForgeVirtualTable authors the same component for React and Vue', () => {
