...
/**
 * `ForgeResponsiveImage` is the write-once `ForgeResponsiveImage` component of
...
const meta = {
  title: 'Atoms/Media/ForgeResponsiveImage',
  component: ForgeResponsiveImage,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Cross-framework `ForgeResponsiveImage` — authored once in the neutral JSX dialect and shipped to all supported frameworks. It renders a `<picture>` with art-directed / format-specific sources, native lazy loading, async decoding, a fixed aspect ratio, and `object-fit` control. Styling comes from the co-located `forge-responsive-image.module.scss`.',
      },
    },
  },
  argTypes: {
  ...
  render: (arguments_) => (
    <div style={{ maxWidth: 480 }}>
      <ForgeResponsiveImage {...arguments_} />
    </div>
  ),
} satisfies Meta<typeof ForgeResponsiveImage>;
