...
על `@mission-platform/forge-jsx`; תפריט ופקדים דמויי טבלה משתמשים גם כן
...
משתמש ב-`@mission-platform/forge-jsx`, כאשר טקסט או גליפים מורכבים,
...
`@mission-platform/forge-jsx` וכן, עבור בקרות קרוסלה, `@mission-platform/icons`;
...
השתמש ב-`@mission-platform/forge-jsx`, אייקונים נבחרים מ-`@mission-platform/icons`,
