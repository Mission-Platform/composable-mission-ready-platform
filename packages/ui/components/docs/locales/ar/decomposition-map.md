...
على `@mission-platform/forge-jsx`؛ تستخدم أيضًا عناصر التحكم القائمة والجدول
...
يستخدم `@mission-platform/forge-jsx`، وحيث يتم تكوين النص أو الحروف الرسومية،
...
`@mission-platform/forge-jsx`، ولعناصر التحكم في الرف الدائري، `@mission-platform/icons`؛
...
استخدم `@mission-platform/forge-jsx`، والأيقونات المحددة من `@mission-platform/icons`،
