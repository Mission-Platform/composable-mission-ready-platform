import { type MpChild, type MpElement, Slot, useEffect, useState } from '@mission-platform/forge-jsx';
 ...
 */
export function ForgeThemeProvider(properties: Readonly<ThemeProviderProperties>): MpElement {
  ...
  return (
    <div className={[styles['forge-theme-provider'], size ? `forge-size--${size}` : undefined]}>
      <Slot
        theme={theme}
