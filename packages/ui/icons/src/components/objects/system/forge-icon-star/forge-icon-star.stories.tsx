...
/**
 * `ForgeIconStar` is a cross-framework icon
 * `ForgeIconStar` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/objects/system/forge-icon-star',
