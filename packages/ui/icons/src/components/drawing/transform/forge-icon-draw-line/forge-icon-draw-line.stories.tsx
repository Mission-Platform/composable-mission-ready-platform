import { ForgeIconDrawLine } from '@mission-platform/icons';
 ...
 */
const meta = {
  title: 'icons/drawing/transform/forge-icon-draw-line',
  component: ForgeIconDrawLine,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconDrawLine>;
