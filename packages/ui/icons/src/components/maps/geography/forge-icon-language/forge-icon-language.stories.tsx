...
/**
 * `ForgeIconLanguage` is a cross-framework icon
 * `ForgeIconLanguage` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/maps/geography/forge-icon-language',
  component: ForgeIconLanguage,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconLanguage>;
