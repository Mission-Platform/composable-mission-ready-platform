...
/**
 * `ForgeIconClose` is a cross-framework icon
 * `ForgeIconClose` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/navigation/controls/forge-icon-close',
  component: ForgeIconClose,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconClose>;
