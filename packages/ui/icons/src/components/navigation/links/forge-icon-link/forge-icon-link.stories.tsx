import { ForgeIconLink } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeIconLink` is a cross-framework icon
 * `ForgeIconLink` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/navigation/links/forge-icon-link',
  component: ForgeIconLink,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconLink>;
