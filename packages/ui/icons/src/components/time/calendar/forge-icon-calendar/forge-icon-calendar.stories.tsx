...
/**
 * `ForgeIconCalendar` is a cross-framework icon
 * `ForgeIconCalendar` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/time/calendar/forge-icon-calendar',
  component: ForgeIconCalendar,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconCalendar>;
