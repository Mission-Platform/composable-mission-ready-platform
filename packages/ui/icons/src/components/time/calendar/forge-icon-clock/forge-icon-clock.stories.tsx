...
/**
 * `ForgeIconClock` is a cross-framework icon
 * `ForgeIconClock` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/time/calendar/forge-icon-clock',
  component: ForgeIconClock,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconClock>;
