...
/**
 * `ForgeIconUpload` is a cross-framework icon
 * `ForgeIconUpload` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/content/files/forge-icon-upload',
  component: ForgeIconUpload,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconUpload>;
