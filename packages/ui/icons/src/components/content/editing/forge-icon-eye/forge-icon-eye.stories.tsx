import { ForgeIconEye } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeIconEye` is a cross-framework icon
 * `ForgeIconEye` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/content/editing/forge-icon-eye',
  component: ForgeIconEye,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconEye>;
