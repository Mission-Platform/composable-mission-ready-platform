import { ForgeIconTable } from '@mission-platform/icons';

import type { Meta, StoryObj } from '@mission-platform/storybook-framework';

/**
 * `ForgeIconTable` is a cross-framework icon
 * `ForgeIconTable` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/data/tables/forge-icon-table',
  component: ForgeIconTable,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconTable>;
