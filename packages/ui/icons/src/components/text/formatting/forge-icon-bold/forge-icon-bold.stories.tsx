...
/**
 * `ForgeIconBold` is a cross-framework icon
 * `ForgeIconBold` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'icons/text/formatting/forge-icon-bold',
  component: ForgeIconBold,
  tags: ['autodocs'],
  argTypes: {
...
} satisfies Meta<typeof ForgeIconBold>;
