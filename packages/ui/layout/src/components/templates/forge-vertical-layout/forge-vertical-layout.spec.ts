...
import { ForgeVerticalLayout } from './forge-vertical-layout';

/**
 * Exercises the **neutral** `ForgeVerticalLayout` (which composes inline
 * `ForgeDrawer`s) on both frameworks through the `@mission-platform/forge-jsx` runtime
 ...
 */
const ReactVerticalLayout = toReactComponent(ForgeVerticalLayout, 'VerticalLayout');
const VueVerticalLayout = toVueComponent(ForgeVerticalLayout, 'VerticalLayout');

describe('ForgeVerticalLayout authors the same component for React and Vue', () => {
