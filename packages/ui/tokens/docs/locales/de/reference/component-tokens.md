...
### Atome – `packages/ui/components/src/components/atoms/`
...
### Moleküle – `packages/ui/components/src/components/molecules/`
...
### Organismen und Vorlagen – `packages/ui/components/src/components/{organisms,templates}/`
...
### Formulare – `packages/ui/forms/src/components/`
...
### Symbole – `packages/ui/icons/src/components/`
