...
### Átomos — `packages/ui/components/src/components/atoms/`
...
### Moléculas — `packages/ui/components/src/components/molecules/`
...
### Organismos y plantillas — `packages/ui/components/src/components/{organisms,templates}/`
...
### Formularios — `packages/ui/forms/src/components/`
...
### Iconos — `packages/ui/icons/src/components/`
