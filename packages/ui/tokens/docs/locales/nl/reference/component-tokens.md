...
### Atomen — `packages/ui/components/src/components/atoms/`
...
### Moleculen — `packages/ui/components/src/components/molecules/`
...
### Organismen en sjablonen — `packages/ui/components/src/components/{organisms,templates}/`
...
### Formulieren — `packages/ui/forms/src/components/`
...
### Pictogrammen — `packages/ui/icons/src/components/`
