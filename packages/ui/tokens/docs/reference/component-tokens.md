...
### Atoms — `packages/ui/components/src/components/atoms/`
...
### Molecules — `packages/ui/components/src/components/molecules/`
...
### Organisms and templates — `packages/ui/components/src/components/{organisms,templates}/`
...
### Forms — `packages/ui/forms/src/components/`
...
### Icons — `packages/ui/icons/src/components/`
