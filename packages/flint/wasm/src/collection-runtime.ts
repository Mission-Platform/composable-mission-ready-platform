 ...
 */
export function buildFlintWasmCollectionRuntimeWasmBodies(allocatorIndex: number): readonly number[][] {
...
const collectionOperations: readonly FlintWasmRuntimeBody[] = [
