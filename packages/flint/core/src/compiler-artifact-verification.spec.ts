...
vi.mock('@mission-platform/flint-wasm', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@mission-platform/flint-wasm')>();
  return {
    ...actual,
    verifyFlintWasmArtifact: verification.verify,
  };
});
