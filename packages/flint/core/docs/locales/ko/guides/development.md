...
게시하기 전에 `pnpm --filter @mission-platform/flint build`을 실행하세요.
...
Node 관련 도구는 `@mission-platform/flint-cli`에 속합니다.

## 생성 및 소스 아티팩트

`src/self-hosted/fws/` 아래에 체크인된 `.flint` 소스는 소스 아티팩트입니다.
