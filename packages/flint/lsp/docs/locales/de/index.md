...
- [`llms.txt` im Sprachpaket](../../../../flint/llms.txt) – Kern
  Hinweise zur Sprach-API.

Der Server benötigt Node.js `>=24.0.0` und stellt `flint-lsp` bereit
