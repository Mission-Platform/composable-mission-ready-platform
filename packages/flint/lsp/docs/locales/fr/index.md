...
- [`llms.txt` dans le package de langue](../../../../flint/llms.txt) — noyau
  Notes sur l'API du langage.

Le serveur nécessite Node.js `>=24.0.0` et expose le `flint-lsp`
