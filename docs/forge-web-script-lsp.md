...
AssemblyScript integrations. See [Forge Web Script v1](./forge-web-script.md)
...
forms, are specified in [the FWS language reference](./forge-web-script.md).
...
remain in `packages/forge-web-script/src/fixtures/bootstrap.ts` and
`docs/forge-web-script.md`.
