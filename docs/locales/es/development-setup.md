...
el escáner de código neutral se compila a partir de su gráfico Flint; no lo hace
...
Si un artefacto de Flint no se puede compilar, inspeccione los diagnósticos del compilador
