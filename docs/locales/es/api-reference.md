...
| `@mission-platform/barcode-decode-wasm`     | Módulo WebAssembly decodificador de código de barras generado.     |
| `@mission-platform/barcode-encode-wasm`     | Módulo WebAssembly del codificador de código de barras generado.     |
