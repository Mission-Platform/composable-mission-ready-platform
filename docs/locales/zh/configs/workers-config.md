...
- [`@mission-platform/api-proxy`](../../../../workers/api-proxy/docs/locales/zh/index.md) — 受限只读 API 代理。
- [`@mission-platform/email-sender`](../../../../workers/email-sender/docs/locales/zh/index.md) — 本地 MailPit 支持的发件人。
- [`@mission-platform/forge-spa`](../../../../workers/forge-spa/docs/locales/zh/index.md) — 共享 `ASSETS` SPA 后备处理程序。
...
|应用 |处理程序 |配置|资产|
| :---------- | :------ | :------------ | :----- |
|网站 | `workers/forge-spa/dist/index.js` | `apps/website/wrangler.jsonc` | `apps/website/dist/`，绑定为 `ASSETS` |
|我的护理笔记| `workers/forge-spa/dist/index.js` | `apps/my-care-notes/wrangler.jsonc` | `apps/my-care-notes/dist/`，绑定为 `ASSETS` |
