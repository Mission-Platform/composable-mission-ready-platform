...
**Compiler Baseline:** SonIR 1.0 (`FORGE_WEB_SCRIPT_SON_SCHEMA_VERSION = '1.0'`) in `@mission-platform/forge-web-script`  
...
**Compiler:** `@mission-platform/forge-web-script`
...
The active compiler (`@mission-platform/forge-web-script`) currently emits SonIR 1.0 (`FORGE_WEB_SCRIPT_SON_SCHEMA_VERSION = '1.0'`):
...
```
       ...
       ├────────────────────────────────────────────────────────┤
       │ Node ID: u32                                           │
       │ OpCode:  ForgeWebScriptSoNOpCode                       │
       │ Type:    ForgeWebScriptTypeDescriptor                  │
...
```json
{
  ...
  "title": "ForgeWebScriptSonIrModuleV2",
  "type": "object",
  "required": [
    "schemaVersion",
    "abiVersion",
...
- [Forge Web Script Language Specification](forge-web-script-language-specification.md)
