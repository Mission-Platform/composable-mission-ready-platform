...
אם חבילה A וחבילה B שתיהן זקוקות לפיסת היגיון משותפת, העבר היגיון זה לחבילה חדשה ברמה נמוכה יותר (לדוגמה,
...
2. **היגיון ניטרלי של מסגרת מחבר**: שימוש `@mission-platform/forge-jsx` ללוגיקה הליבה כדי להימנע ממחזורים ספציפיים למסגרת.
3. **השתמש בפרוטוקולי Workspace**: השתמש תמיד `workspace:*` להבטחת תלות פנימית pnpm יכול לפתור בצורה נכונה
   הגרף.
4. **בקר באופן קבוע יבוא**: שימו לב להצעות "ייבוא אוטומטי" ב-IDE שלכם, מכיוון שהן יכולות לפעמים להציג
