...
Mission Platform מציגה פרדיגמת פיתוח ניטראלית במסגרת. שימוש בניב `@mission-platform/forge` JSX,
...
- **Forge JSX (`@mission-platform/forge`)**: מסגרת ממשק המשתמש הראשית - זמן ריצה JSX ניטרלי במסגרת
