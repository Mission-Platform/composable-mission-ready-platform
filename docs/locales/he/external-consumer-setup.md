...
רכיבי פלטפורמת המשימה נכתבו פעם אחת באמצעות `@mission-platform/forge-jsx` ומופצים כחבילות מרובות ספציפיות למסגרת (Vue 3, React, Solid ורכיבי אינטרנט) בתוך חבילה אחת.
