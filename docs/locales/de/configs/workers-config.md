...
- [`@mission-platform/api-proxy`](../../../../packages/edge/workers/api-proxy/docs/locales/de/index.md) – eingeschränkter schreibgeschützter API-Proxy.
- [`@mission-platform/email-sender`](../../../../packages/edge/workers/email-sender/docs/locales/de/index.md) – lokaler, von MailPit unterstützter Absender.
- [`@mission-platform/forge-spa`](../../../../packages/edge/workers/forge-spa/docs/locales/de/index.md) – geteilt `ASSETS` SPA-Fallback-Handler.
