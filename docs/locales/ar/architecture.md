...
قلب منصة المهمة هو `@mission-platform/forge-jsx`، نموذج تأليف محايد للإطار للمكونات و
...
و `forge-cms-webflow` كل منها يمتلك منصة واحدة. هدف نظام إدارة المحتوى _يؤلف_ مكونًا إضافيًا لإطار العمل بدلاً من استبداله، لذلك
