...
المكون عبارة عن وحدة "للكتابة مرة واحدة" تم تأليفها بلهجة Forge JSX المحايدة (`@mission-platform/forge-jsx`)، ضمان
...
1. **حيادية إطار العمل**: لا يُفصل المؤلف مطلقًا Vue و React الإصدارات. يستخدم `@mission-platform/forge-jsx`.
