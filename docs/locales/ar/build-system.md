...
[صياغة خط أنابيب مترجم](../../../packages/tooling/vite/forge/docs/locales/ar/reference/compiler.md).
...
تكوينات البناء مركزية في `packages/tooling/configs/` الدليل للحفاظ على الاتساق عبر monorepo.
