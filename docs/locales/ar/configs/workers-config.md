...
- [`@mission-platform/api-proxy`](../../../../workers/api-proxy/docs/locales/ar/index.md) - وكيل API مقيد للقراءة فقط.
- [`@mission-platform/email-sender`](../../../../workers/email-sender/docs/locales/ar/index.md) - المرسل المحلي المدعوم من MailPit.
- [`@mission-platform/forge-spa`](../../../../workers/forge-spa/docs/locales/ar/index.md) - مشترك `ASSETS` معالج احتياطي SPA.
...
| :---------- | :------ | :------------ | :----- |
| الموقع | `workers/forge-spa/dist/index.js` | `apps/website/wrangler.jsonc` | `apps/website/dist/`، ملزمة كما `ASSETS` |
| ملاحظات العناية الخاصة بي | `workers/forge-spa/dist/index.js` | `apps/my-care-notes/wrangler.jsonc` | `apps/my-care-notes/dist/`، ملزمة كما `ASSETS` |
