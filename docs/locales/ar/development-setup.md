...
يتم تجميع الماسح الضوئي للكود المحايد من الرسم البياني Flint الخاص به؛ لا
...
إذا فشل إنشاء قطعة أثرية لـ Flint، فافحص تشخيصات برنامج التحويل البرمجي الخاص بها
