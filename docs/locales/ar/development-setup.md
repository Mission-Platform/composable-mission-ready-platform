...
| **الصدأ** | سلسلة أدوات مستقرة | تطوير معيار الصدأ الاختياري المستقل |
...
يتم تجميع الماسح الضوئي للكود المحايد من الرسم البياني Forge Web Script الخاص به؛ لا
تتطلب الصدأ أو `wasm-pack` خطوة البناء.
...
إذا فشل إنشاء قطعة أثرية لـ Forge Web Script، فافحص تشخيصات برنامج التحويل البرمجي الخاص بها
وتحقق من ملف تعريف الارتباط الثابت أو الديناميكي المحدد. ال
`@mission-platform/hunspell` يتطلب إنشاء Emscripten أيضًا قيام Docker بذلك
يكون قيد التشغيل.
