...
- [`@mission-platform/api-proxy`](../../../../workers/api-proxy/docs/locales/ja/index.md) — 制約付き読み取り専用 API プロキシ。
- [`@mission-platform/email-sender`](../../../../workers/email-sender/docs/locales/ja/index.md) — MailPit を利用したローカルの送信者。
- [`@mission-platform/forge-spa`](../../../../workers/forge-spa/docs/locales/ja/index.md) — 共有 `ASSETS` SPA フォールバック ハンドラー。
...
| :---------- | :------ | :------------ | :----- |
|ウェブサイト | `workers/forge-spa/dist/index.js` | `apps/website/wrangler.jsonc` | `apps/website/dist/`、次のようにバインドされます `ASSETS` |
|私のケアノート | `workers/forge-spa/dist/index.js` | `apps/my-care-notes/wrangler.jsonc` | `apps/my-care-notes/dist/`、次のようにバインドされます `ASSETS` |
