 ...
 */
export const APP_ORIGIN = 'https://my-care-notes.mission-platform.dev/';
...
export const PUBLISHER_URL = 'https://mission-platform.dev/';
export const PUBLISHER_LOGO = 'https://mission-platform.dev/icon.svg';
