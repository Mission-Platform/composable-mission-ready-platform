import { IconMinus } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconMinus` is the React build of the cross-framework icon
 * `IconMinus` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Math / Quantity/IconMinus',
  component: IconMinus,
  tags: ['autodocs'],
  argTypes: {
