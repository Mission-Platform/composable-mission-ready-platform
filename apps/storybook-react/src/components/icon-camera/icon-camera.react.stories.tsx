import { IconCamera } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconCamera` is the React build of the cross-framework icon
 * `IconCamera` in `@mission-platform/icons`, authored once in the neutral JSX
...
} satisfies Meta<typeof IconCamera>;
