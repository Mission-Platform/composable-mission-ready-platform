import { IconPlus } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconPlus` is the React build of the cross-framework icon
 * `IconPlus` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Math / Quantity/IconPlus',
  component: IconPlus,
  tags: ['autodocs'],
  argTypes: {
