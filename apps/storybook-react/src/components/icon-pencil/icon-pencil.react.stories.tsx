import { IconPencil } from '@mission-platform/icons/react';

import type { Meta, StoryObj } from '@storybook/react-vite';

/**
 * `IconPencil` is the React build of the cross-framework icon
 * `IconPencil` in `@mission-platform/icons`, authored once in the neutral JSX
 ...
 */
const meta = {
  title: 'Icons/Actions/IconPencil',
