 ...
 *
 * The neutral `@mission-platform/forge` import is replaced by:
 ...
 *   any remaining neutral types kept against `@mission-platform/forge`.
 */
...
const SOLID_ADAPTER_MODULE = '@mission-platform/forge/solid';
