...
emitted declarations — carry **no** `@mission-platform/jsx` render/props type
...
(not UI components) authored against the neutral `@mission-platform/jsx` hooks,
...
`compileHookModule` (React = a light `@mission-platform/jsx` → `react` import
...
import { generateFrameworkSources, jsxComponentsDtsPlugin, reactJsxPlugin } from '@mission-platform/vite-plugin-jsx';
...
import { generateFrameworkSources, jsxComponentsDtsPlugin } from '@mission-platform/vite-plugin-jsx';
