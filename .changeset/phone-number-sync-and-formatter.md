---
'@mission-platform/phone-number': minor
'@mission-platform/vite-plugin-assemblyscript': minor
---

Add a synchronous instantiation path and higher-level phone helpers so
