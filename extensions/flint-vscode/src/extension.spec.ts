...
describe('Flint VS Code client lifecycle', () => {
  beforeEach(() => {
  ...
  it('starts the flint client with stdio settings and disposes it on deactivation', async () => {
    ...
    expect(instance.constructorArguments[0]).toBe('flint');
