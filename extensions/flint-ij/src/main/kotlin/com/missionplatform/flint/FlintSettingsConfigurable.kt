...
class FlintSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Flint"
    ...
    override fun createComponent(): JComponent {
        ...
        val fields = listOf(
            ...
            "Flint runtime executable:" to JTextField(),
            "Flint runtime arguments:" to JTextField(),
        )
        ...
        val activationBox = JCheckBox("Start the language server when a Flint file is opened")
    ...
    override fun isModified(): Boolean {
        val settings = FlintSettingsState.getInstance()
